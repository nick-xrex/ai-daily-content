...
id: inbox_ecada770
date: 2026-06-24
source_ref: "[[00-inbox/2026-06-24/2200-gitnexus-releases-release-candidate-v1-6-9-rc-16-fe93]]"
title: "Release Candidate v1.6.9-rc.16"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.9-rc.16
source: gitnexus-releases
published_at: 2026-06-24T11:51:57+00:00
fetched_at: 2026-06-24T22:04:38.502962+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.9-rc.16 發布，變更清單與 rc.17 相同，為同一版本開發週期內的迭代自動化構建。"
key_points:
...
GitNexus v1.6.9-rc.16 發布，變更清單與 rc.17 相同，為同一版本開發週期內的迭代自動化構建。

### 重點
- Python 及 Java source/sink 安全模型支援
- 跨倉庫 PDG 調用追踪、Django 多倉庫路由提取、Kotlin Spring HTTP 消費者提取功能

**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.9-rc.16)
