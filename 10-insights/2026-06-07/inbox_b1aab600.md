...
id: inbox_b1aab600
date: 2026-06-07
source_ref: "[[00-inbox/2026-06-07/2345-gitnexus-releases-release-candidate-v1-6-6-rc-155-8b56]]"
title: "Release Candidate v1.6.6-rc.155"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.155
source: gitnexus-releases
published_at: 2026-06-07T14:03:45+00:00
fetched_at: 2026-06-07T23:49:57.310381+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.155 發布，為重複的 release candidate 版本，內容完全同 rc.156。包含 MCP 啟動相容性改進、git commit 自動重新索引並保留 embeddings、HTTP embedding 後端、完整 Swift 語言支持、Docker 支持。修復了大型倉庫的 parse cache 持久化問題與 Go O(n²) 性能回歸。此版本為 rc.155，繼續供早期測試用戶驗證。"
key_points:
  - "MCP 啟動相容性與懶加載 CLI 指令改進，提升 Claude Code 集成穩定性"
  - "解決大型倉庫 parse cache 持久化（PR #1580）與 O(n²) 作用域捕獲問題"
  - "新增 Docker 與完整 Swift 語言支持"
tags: [gitnexus, rc-release, code-analysis, mcp]
topics: []
importance: 1
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.155

GitNexus v1.6.6-rc.155 發布，為重複的 release candidate 版本，內容完全同 rc.156。包含 MCP 啟動相容性改進、git commit 自動重新索引並保留 embeddings、HTTP embedding 後端、完整 Swift 語言支持、Docker 支持。修復了大型倉庫的 parse cache 持久化問題與 Go O(n²) 性能回歸。此版本為 rc.155，繼續供早期測試用戶驗證。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.155)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.155 \n Target base: 1.6.6 (rc #155 )\n Source commit (main): f0c292f \n Release commit (versioned tree): f2a9651 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
