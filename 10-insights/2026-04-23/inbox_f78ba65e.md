...
id: inbox_f78ba65e
date: 2026-04-23
source_ref: "[[00-inbox/2026-04-23/0246-codex-releases-0-123-0-e1e6]]"
title: "0.123.0"
url: https://github.com/openai/codex/releases/tag/rust-v0.123.0
source: codex-releases
published_at: 2026-04-23T01:26:41+00:00
fetched_at: 2026-04-24T02:53:10.770049+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "OpenAI Codex 0.123.0 發布。新增內建 Amazon Bedrock 模型提供者，支持 AWS profile 配置。/mcp verbose 命令提供完整 MCP 伺服器診斷、資源和資源模板，同時保持 /mcp 快速。Plugin MCP 加載現支持 mcpServers 和 top-level server maps 兩種 .mcp.json 格式。Realtime handoffs 改進讓背景代理接收 transcript delta 並可顯式保持沈默。新增 host 特定 remote_sandbox_config 支持，模型元數據更新（gpt-5.4 為預設）。修復 /copy rollback、手動 shell 命令隊列、VS Code WSL Unicode 輸入等問題。"
key_points:
  - "Amazon Bedrock 內建提供者支持 AWS profile 配置，擴展模型選項"
  - "/mcp verbose 提供完整 MCP 診斷（伺服器、資源、資源模板），/mcp 保持快速"
  - "Plugin MCP 支持 mcpServers 和 top-level server map 格式，Realtime handoffs 支持 transcript delta 和顯式沈默"
tags: [codex, mcp, bedrock, ai-tools, realtime-agents]
topics: [agents.mcp]
importance: 4
novelty: 3
insight_quality: 3
...
**原文：** [codex-releases](https://github.com/openai/codex/releases/tag/rust-v0.123.0)
