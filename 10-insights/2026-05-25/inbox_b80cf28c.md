...
id: inbox_b80cf28c
date: 2026-05-25
source_ref: "[[00-inbox/2026-05-25/0014-gitnexus-releases-release-candidate-v1-6-6-rc-56-0887]]"
title: "Release Candidate v1.6.6-rc.56"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.56
source: gitnexus-releases
published_at: 2026-05-25T06:31:54+00:00
fetched_at: 2026-05-26T00:19:14.417011+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.56 發佈內容同 rc.57/rc.58。MCP 啟動相容性安全強化、Swift iOS 完整支援、HTTP Embedding 遠端端點、Docker 支援。Bug 修復聚焦全域升級 ENOTEMPTY 防止、快取目錄可寫位置設定、大型倉庫快取分片持久化。資料庫遷移 KuzuDB → LadybugDB 0.15；九階段跨語言類型解析框架（Phase 1–9），最新達成返回型別感知迴圈推理與容器描述元支援；新增 ACCESSES 邊緣型別用於欄位讀寫追蹤。"
key_points:
  - "MCP 啟動相容性強化 + CLI 指令惰性載入，修復 KuzuDB fork 崩潰與全域升級 ENOTEMPTY 錯誤（#843、#209）"
  - "新增語言支援：Swift/iOS（SPM 導入解析）、Ruby（方法層級呼叫解析）；Docker 容器化（#408、#278、#848）"
  - "九階段類型解析演進（Phase 1–9 涵蓋 10+ 語言、#310–#372）；KuzuDB → LadybugDB 遷移；ACCESSES 邊緣型別追蹤"
tags: [gitnexus, release-candidate, type-system, multi-language, mcp-integration]
topics: [agents.mcp]
importance: 4
novelty: 3
insight_quality: 4
...
## Release Candidate v1.6.6-rc.56

GitNexus v1.6.6-rc.56 發佈內容同 rc.57/rc.58。MCP 啟動相容性安全強化、Swift iOS 完整支援、HTTP Embedding 遠端端點、Docker 支援。Bug 修復聚焦全域升級 ENOTEMPTY 防止、快取目錄可寫位置設定、大型倉庫快取分片持久化。資料庫遷移 KuzuDB → LadybugDB 0.15；九階段跨語言類型解析框架（Phase 1–9），最新達成返回型別感知迴圈推理與容器描述元支援；新增 ACCESSES 邊緣型別用於欄位讀寫追蹤。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.56)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.56 \n Target base: 1.6.6 (rc #56 )\n Source commit (main): 73a6a53 \n Release commit (versioned tree): 6fefeef \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
