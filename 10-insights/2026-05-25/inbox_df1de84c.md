...
id: inbox_df1de84c
date: 2026-05-25
source_ref: "[[00-inbox/2026-05-25/0014-gitnexus-releases-release-candidate-v1-6-6-rc-57-52cb]]"
title: "Release Candidate v1.6.6-rc.57"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.57
source: gitnexus-releases
published_at: 2026-05-25T10:42:12+00:00
fetched_at: 2026-05-26T00:19:14.416399+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.57 發佈內容與 rc.58 相同。MCP 啟動相容性強化、Swift/iOS 完整支援、HTTP Embedding 遠端端點、Docker 容器支援。KuzuDB → LadybugDB 0.15 遷移；九階段跨語言類型解析持續演進（Phase 1–9，涵蓋 10+ 語言）；新增 ACCESSES 邊緣型別用於欄位存取追蹤。全域升級 ENOTEMPTY 修復、快取目錄權限改進、大型倉庫快取持久化。"
key_points:
  - "MCP 啟動相容性與 CLI 惰性載入；修復 KuzuDB fork 及全域升級問題（#843、#209）"
  - "Swift/iOS 完整支援（SPM 導入解析）；Ruby 方法層級呼叫解析；Docker 容器化（#408、#278、#848）"
  - "九階段類型解析框架（10+ 語言、Phase 1–9）；LadybugDB 0.15 遷移；ACCESSES 邊緣追蹤"
tags: [gitnexus, mcp-compatibility, type-resolution, swift-ios, database-migration]
topics: [agents.mcp]
importance: 4
novelty: 3
insight_quality: 4
...
## Release Candidate v1.6.6-rc.57

GitNexus v1.6.6-rc.57 發佈內容與 rc.58 相同。MCP 啟動相容性強化、Swift/iOS 完整支援、HTTP Embedding 遠端端點、Docker 容器支援。KuzuDB → LadybugDB 0.15 遷移；九階段跨語言類型解析持續演進（Phase 1–9，涵蓋 10+ 語言）；新增 ACCESSES 邊緣型別用於欄位存取追蹤。全域升級 ENOTEMPTY 修復、快取目錄權限改進、大型倉庫快取持久化。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.57)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.57 \n Target base: 1.6.6 (rc #57 )\n Source commit (main): efcab45 \n Release commit (versioned tree): dea9804 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
