...
id: inbox_e2a912f7
date: 2026-05-25
source_ref: "[[00-inbox/2026-05-25/0014-gitnexus-releases-release-candidate-v1-6-6-rc-60-594b]]"
title: "Release Candidate v1.6.6-rc.60"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.60
source: gitnexus-releases
published_at: 2026-05-25T12:47:14+00:00
fetched_at: 2026-05-26T00:17:48.808762+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.60 發布候選版本，變更日誌與 rc.59–63 全數相同。主要改進面向 MCP 相容性強化、語言支援擴展（Swift、Ruby、Kotlin 等）、HTTP embedding backend 自託管支援、Docker 容器化、Phase 9 類型解析推進，及 preinstall cleanup、cache dir 等修正。"
key_points:
  - "連續 rc 發布：rc.60 日誌與 rc.59–63 完全相同"
  - "MCP 啟動相容性 + lazy-load CLI 命令"
  - "Swift/Ruby/Kotlin 完整語言支援、HTTP embedding、Docker、Phase 9"
...
## Release Candidate v1.6.6-rc.60

GitNexus v1.6.6-rc.60 發布候選版本，變更日誌與 rc.59–63 全數相同。主要改進面向 MCP 相容性強化、語言支援擴展（Swift、Ruby、Kotlin 等）、HTTP embedding backend 自託管支援、Docker 容器化、Phase 9 類型解析推進，及 preinstall cleanup、cache dir 等修正。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.60)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.60 \n Target base: 1.6.6 (rc #60 )\n Source commit (main): baf57be \n Release commit (versioned tree): 2ee04a3 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
