...
id: inbox_2183b70e
date: 2026-05-25
source_ref: "[[00-inbox/2026-05-25/0014-gitnexus-releases-release-candidate-v1-6-6-rc-58-7079]]"
title: "Release Candidate v1.6.6-rc.58"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.58
source: gitnexus-releases
published_at: 2026-05-25T11:26:13+00:00
fetched_at: 2026-05-26T00:19:14.413522+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.58 發佈，強化 MCP 啟動相容性及安全性，新增 Swift 完整支援（含 SPM 導入解析）、HTTP Embedding 遠端端點、Docker 容器化。Bug 修復著重全域升級 ENOTEMPTY 錯誤防止、快取目錄權限設定、大型倉庫快取分片持久化。核心進展：KuzuDB → LadybugDB 0.15 遷移；九階段跨語言類型解析架構（Phase 1–9，涵蓋 10+ 語言），從基礎推斷演進至返回型別感知迴圈推理與容器描述元；新增 ACCESSES 邊緣型別追蹤欄位讀寫語義。"
key_points:
  - "MCP 啟動相容性 + CLI 指令惰性載入修復 KuzuDB fork 崩潰（#209）；preinstall 清理防止全域升級 ENOTEMPTY（#843）"
  - "Swift/iOS 完整支援含 SPM 導入解析（#408）；Ruby 方法層級呼叫解析 + HAS_METHOD 邊緣（#278）；新增 Docker 支援（#848）"
  - "九階段類型解析（Phase 6 達 10 語言、#318；Phase 8 欄位型別、#354；Phase 9 返回感知變數繫結）；LadybugDB 遷移（#275）"
tags: [gitnexus, mcp-startup, cross-language-types, embeddings-backend, swift-support]
topics: [agents.mcp]
importance: 4
novelty: 3
insight_quality: 4
...
## Release Candidate v1.6.6-rc.58

GitNexus v1.6.6-rc.58 發佈，強化 MCP 啟動相容性及安全性，新增 Swift 完整支援（含 SPM 導入解析）、HTTP Embedding 遠端端點、Docker 容器化。Bug 修復著重全域升級 ENOTEMPTY 錯誤防止、快取目錄權限設定、大型倉庫快取分片持久化。核心進展：KuzuDB → LadybugDB 0.15 遷移；九階段跨語言類型解析架構（Phase 1–9，涵蓋 10+ 語言），從基礎推斷演進至返回型別感知迴圈推理與容器描述元；新增 ACCESSES 邊緣型別追蹤欄位讀寫語義。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.58)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.58 \n Target base: 1.6.6 (rc #58 )\n Source commit (main): 5e8690f \n Release commit (versioned tree): 26b3c17 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
