...
id: inbox_f440dad5
date: 2026-06-25
source_ref: "[[00-inbox/2026-06-25/2200-gitnexus-releases-release-candidate-v1-6-9-rc-22-4049]]"
title: "Release Candidate v1.6.9-rc.22"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.9-rc.22
source: gitnexus-releases
published_at: 2026-06-25T13:41:19+00:00
fetched_at: 2026-06-25T22:04:06.119523+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 发布 v1.6.9-rc.22（rc #22 / npm: gitnexus@rc），面向多语言代码分析工具的发布候选版本。核心改进包括：增加 Python 和 Java source/sink 安全模型；Kotlin Spring HTTP 消费者提取与 Java 提供者奇偶校验；Django 多仓库路由提取；跨仓库调用链追踪（使用 PDG）；Spring 接口继承路由解析；全语言文档注释可搜索；性能优化：跳过图形覆盖路由文件的源解析；Nuxt/Nitro auto-imports TypeScript 作用域解析；FTS 索引描述字段以支持文档注释关键词搜索。修复 LadybugDB 双重释放崩溃和连接序列化问题。"
key_points:
  - "增加 Python 和 Java source/sink 安全分析模型，扩展 taint 追踪覆盖范围"
  - "Kotlin Spring HTTP 消费者提取达到与 Java 提供者奇偶校验，Django 多仓库支持，跨仓库调用追踪使用 PDG"
  - "性能优化（跳过已覆盖路由文件源解析）；全语言文档注释可搜索；修复 LadybugDB 连接序列化和双重释放问题"
...
GitNexus 发布 v1.6.9-rc.22（rc #22 / npm: gitnexus@rc），面向多语言代码分析工具的发布候选版本。核心改进包括：增加 Python 和 Java source/sink 安全模型；Kotlin Spring HTTP 消费者提取与 Java 提供者奇偶校验；Django 多仓库路由提取；跨仓库调用链追踪（使用 PDG）；Spring 接口继承路由解析；全语言文档注释可搜索；性能优化：跳过图形覆盖路由文件的源解析；Nuxt/Nitro auto-imports TypeScript 作用域解析；FTS 索引描述字段以支持文档注释关键词搜索。修复 LadybugDB 双重释放崩溃和连接序列化问题。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.9-rc.22)
