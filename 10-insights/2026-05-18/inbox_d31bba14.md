...
id: inbox_d31bba14
date: 2026-05-18
source_ref: "[[00-inbox/.../inbox_d31bba14]]"
title: "0.131.0"
url: https://github.com/openai/codex/releases/tag/rust-v0.131.0
source: codex-releases
published_at: 2026-05-18T18:05:43+00:00
fetched_at: 2026-05-19T02:25:07.937717+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "OpenAI Codex v0.131.0 發布，帶來多項 TUI 與工程改進。主要新功能：TUI 數據驅動的服務層命令、混合令牌計數顯示、權限/批准模式指示、響應式 Markdown 表格；@mentions 支持跨文件、目錄、插件、技能的統一選擇器；插件工作流新增市場 CLI 命令、版本共享、權限管理；遠端工作流支持 daemon 生命週期管理、registry 配置環境、runtime 啟用/禁用 API；Python SDK 遷移至 openai-codex 命名空間，支持並發路由、類型固定、批准模式集成；新增 codex doctor 診斷工具覆蓋運時、認證、網路、配置。大量修復強化 Windows 沙盒、Git 可靠性、SQLite 啟動安全。"
key_points:
  - "TUI 增強數據驅動服務層命令與混合令牌計數，權限/批准模式指示，響應式 Markdown 表格"
  - "Python SDK 遷移 openai-codex 命名空間，支持並發路由、類型固定、批准模式集成"
  - "遠端工作流 daemon 生命週期管理、registry 配置環境；新增 codex doctor 全方位診斷工具"
tags: [codex, version-release, python-sdk, tui-enhancement, plugin-marketplace]
...
OpenAI Codex v0.131.0 發布，帶來多項 TUI 與工程改進。主要新功能：TUI 數據驅動的服務層命令、混合令牌計數顯示、權限/批准模式指示、響應式 Markdown 表格；@mentions 支持跨文件、目錄、插件、技能的統一選擇器；插件工作流新增市場 CLI 命令、版本共享、權限管理；遠端工作流支持 daemon 生命週期管理、registry 配置環境、runtime 啟用/禁用 API；Python SDK 遷移至 openai-codex 命名空間，支持並發路由、類型固定、批准模式集成；新增 codex doctor 診斷工具覆蓋運時、認證、網路、配置。大量修復強化 Windows 沙盒、Git 可靠性、SQLite 啟動安全。
...
**原文：** [codex-releases](https://github.com/openai/codex/releases/tag/rust-v0.131.0)
...
New Features 
 ...
 #22343 feat(exec-server): use protobuf rela
