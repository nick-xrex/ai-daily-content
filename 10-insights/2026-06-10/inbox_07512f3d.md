...
id: inbox_07512f3d
date: 2026-06-10
source_ref: "[[00-inbox/.../inbox_07512f3d]]"
title: "Release Candidate v1.6.8-rc.16"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.16
source: gitnexus-releases
published_at: 2026-06-10T21:39:22+00:00
fetched_at: 2026-06-11T00:21:04.276794+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 發佈 1.6.8-rc.16 release candidate。本版本包含 13 項修復與功能新增：VECTOR 索引創建改進（#2114）、Docker 資產包含（#2130）、多分支索引與分支限定查詢（#2106）、Java Spring annotation 提取（#2078）、TS/JS 控制流圖層（#2081）、impact()/route_map blast radius 計算修復（#2129）、embeddings 依賴解決（#307）等。RC 版本供提前測試，穩定版本維持在 latest dist-tag。"
key_points:
...
## Release Candidate v1.6.8-rc.16

GitNexus 發佈 1.6.8-rc.16 release candidate。本版本包含 13 項修復與功能新增：VECTOR 索引創建改進（#2114）、Docker 資產包含（#2130）、多分支索引與分支限定查詢（#2106）、Java Spring annotation 提取（#2078）、TS/JS 控制流圖層（#2081）、impact()/route_map blast radius 計算修復（#2129）、embeddings 依賴解決（#307）等。RC 版本供提前測試，穩定版本維持在 latest dist-tag。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.16)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.16 \n Target base: 1.6.8 (rc #16 )\n Source commit (main): 1150eea \n Release commit (versioned tree): 99f6e04 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.16
