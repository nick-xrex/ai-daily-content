...
id: inbox_f6d6e9af
date: 2026-06-10
source_ref: "[[00-inbox/.../inbox_f6d6e9af]]"
title: "Release Candidate v1.6.8-rc.15"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.15
source: gitnexus-releases
published_at: 2026-06-10T21:08:17+00:00
fetched_at: 2026-06-11T00:21:04.283855+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 發佈 1.6.8-rc.15 release candidate，與 rc.16 包含相同的 changelist。包括 VECTOR 索引修復、Docker 資產包含、多分支索引支持、Java Spring annotation 提取、TS/JS 控制流圖層、blast radius 計算修復、embeddings 依賴解決等共 13 項提交。RC 版本供提前測試，穩定版本維持在 latest dist-tag。"
key_points:
...
GitNexus 發佈 1.6.8-rc.15 release candidate，與 rc.16 包含相同的 changelist。包括 VECTOR 索引修復、Docker 資產包含、多分支索引支持、Java Spring annotation 提取、TS/JS 控制流圖層、blast radius 計算修復、embeddings 依賴解決等共 13 項提交。RC 版本供提前測試，穩定版本維持在 latest dist-tag。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.15)
