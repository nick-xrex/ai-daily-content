...
id: inbox_fb24b585
date: 2026-06-10
source_ref: "[[00-inbox/.../inbox_fb24b585]]"
title: "Release Candidate v1.6.8-rc.13"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.13
source: gitnexus-releases
published_at: 2026-06-10T18:41:25+00:00
fetched_at: 2026-06-11T00:21:04.285350+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 發佈 1.6.8-rc.13 release candidate。與 rc.14-rc.16 大部分相同的 changelist（缺少 fix(web) 修復），共 12 項提交，包括 VECTOR 索引修復、Docker 資產包含、多分支索引、Java Spring 提取、TS/JS 控制流圖層、blast radius 修復、embeddings 依賴解決等。RC 版本供提前測試，穩定版本維持在 latest dist-tag。"
key_points:
...
## Release Candidate v1.6.8-rc.13

GitNexus 發佈 1.6.8-rc.13 release candidate。與 rc.14-rc.16 大部分相同的 changelist（缺少 fix(web) 修復），共 12 項提交，包括 VECTOR 索引修復、Docker 資產包含、多分支索引、Java Spring 提取、TS/JS 控制流圖層、blast radius 修復、embeddings 依賴解決等。RC 版本供提前測試，穩定版本維持在 latest dist-tag。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.13)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.13 \n Target base: 1.6.8 (rc #13 )\n Source commit (main): 5bf8a17 \n Release commit (versioned tree): fe9154b \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.13
