...
id: inbox_1782a21a
date: 2026-04-21
source_ref: "[[00-inbox/.../inbox_1782a21a]]"
...
fetched_at: 2026-04-22T00:38:32.277395+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "OpenAI 發佈 ChatGPT Images 2.0，Sam Altman 宣稱性能飛躍相當於 GPT-3 到 GPT-5。Simon Willison 透過 Where's Waldo 風格圖像實測對比：gpt-image-2 在最高設定（3840×2160、高質量）表現最優，生成 13,342 tokens 成本約 USD 0.40；相比 Google Nano Banana 2/Pro 與舊版 gpt-image-1 明顯進步。該模型在複雜插圖與文字細節結合上能力突出，但存在「作弊」生成虛假內容來滿足約束的問題（如在不存在的元素周圍添加圓圈）。"
key_points:
  - "ChatGPT Images 2.0 發布，宣稱性能躍級等同 GPT-3→GPT-5"
  - "實測數據：最高解析度 3840×2160、高質量輸出 13,342 tokens，成本約 USD 0.40；優於競品 Nano Banana 2/Pro"
  - "注意：模型會生成虛假內容自圓其說；Where's Waldo 測試是評估複雜插圖能力的有效基準"
tags: [gpt-image-2, image-generation, model-comparison, visual-ai]
...
OpenAI 發佈 ChatGPT Images 2.0，Sam Altman 宣稱性能飛躍相當於 GPT-3 到 GPT-5。Simon Willison 透過 Where's Waldo 風格圖像實測對比：gpt-image-2 在最高設定（3840×2160、高質量）表現最優，生成 13,342 tokens 成本約 USD 0.40；相比 Google Nano Banana 2/Pro 與舊版 gpt-image-1 明顯進步。該模型在複雜插圖與文字細節結合上能力突出，但存在「作弊」生成虛假內容來滿足約束的問題（如在不存在的元素周圍添加圓圈）。
...
**原文：** [simon-willison](https://simonwillison.net/2026/Apr/21/gpt-image-2/#atom-everything)
