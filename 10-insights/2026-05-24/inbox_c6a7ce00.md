...
id: inbox_c6a7ce00
date: 2026-05-24
source_ref: "[[00-inbox/2026-05-24/0011-gitnexus-releases-release-candidate-v1-6-6-rc-55-a60b]]"
title: "Release Candidate v1.6.6-rc.55"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.55
source: gitnexus-releases
published_at: 2026-05-24T19:54:12+00:00
fetched_at: 2026-05-25T00:14:49.417384+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.55 發布。主要改進包括：MCP 啟動相容性優化與懶加載 CLI 指令（安全性），HTTP embedding 後端支援自部署遠程端點、git commit 後自動重索引保留 embeddings、完整 Swift 支援（SPM、隱式導入、構造器解析）、新增 Docker 容器支援、CLI index 指令註冊現有索引。bug 修正涵蓋全局升級 ENOTEMPTY 防止、緩存目錄權限修正、樹狀解析器生命週期除錯、大倉庫快取分片持久化。本 rc.50–55 系列自動化 CI 構建，內容完全相同。"
key_points:
  - "HTTP embedding 後端支援自部署/遠程端點，突破雲端依賴實現混合部署"
  - "Swift 完整支援含 SPM 解析、Kotlin/PHP/Ruby/JavaScript 等多語言擴展達 10+ 語言"
  - "大倉庫快取分片持久化解決超大規模倉庫的解析記憶體與效能問題"
tags: [code-analysis, mcp, embedding, multi-language, docker]
topics: [agents.mcp]
importance: 3
novelty: 1
insight_quality: 2
...
## Release Candidate v1.6.6-rc.55

GitNexus v1.6.6-rc.55 發布。主要改進包括：MCP 啟動相容性優化與懶加載 CLI 指令（安全性），HTTP embedding 後端支援自部署遠程端點、git commit 後自動重索引保留 embeddings、完整 Swift 支援（SPM、隱式導入、構造器解析）、新增 Docker 容器支援、CLI index 指令註冊現有索引。bug 修正涵蓋全局升級 ENOTEMPTY 防止、緩存目錄權限修正、樹狀解析器生命週期除錯、大倉庫快取分片持久化。本 rc.50–55 系列自動化 CI 構建，內容完全相同。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.55)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.55 \n Target base: 1.6.6 (rc #55 )\n Source commit (main): 1c49932 \n Release commit (versioned tree): a51d7b6 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
