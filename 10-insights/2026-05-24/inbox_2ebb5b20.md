...
id: inbox_2ebb5b20
date: 2026-05-24
source_ref: "[[00-inbox/2026-05-24/0011-gitnexus-releases-release-candidate-v1-6-6-rc-49-5970]]"
title: "Release Candidate v1.6.6-rc.49"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.49
source: gitnexus-releases
published_at: 2026-05-24T06:56:58+00:00
fetched_at: 2026-05-25T00:15:58.857984+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 發布 v1.6.6-rc.49 release candidate，包含 50+ 項功能和修復。新增 Kotlin 語言完整 scope resolver、Java scope-resolution 完成度達 100%、C++ 參數類型和運算符重載支持、JavaScript 遷移至 scope-based resolution (RFC #909)。修復項目包括 WAL corruption 偵測、FTS 驗證和修復機制、Git worktree 支持、多語言界面本地化（i18n）。新增 GitLab 倉庫支持和 DeepSeek V4 API 整合，此版本聚焦於多語言支持完善和資料庫穩定性提升。"
key_points:
  - "Kotlin 完整 scope resolver；Java 遷移至 MIGRATED_LANGUAGES (100% scope-resolution)；JavaScript 遷移完成 (RFC #909)"
  - "WAL corruption 偵測 + FTS 驗證修復；Git worktree 支持；多語言本地化 (i18n)；analyze --repair-fts 命令新增"
  - "DeepSeek V4 API 整合；GitLab 倉庫支持；Windows 全局 MCP 支持修復；Kotlin 虛擬派送和 type refinement 修復"
tags: [git-nexus, scope-resolution, language-support, database-stability, multilingual-support]
topics: []
importance: 4
novelty: 3
insight_quality: 2
...
## Release Candidate v1.6.6-rc.49

GitNexus 發布 v1.6.6-rc.49 release candidate，包含 50+ 項功能和修復。新增 Kotlin 語言完整 scope resolver、Java scope-resolution 完成度達 100%、C++ 參數類型和運算符重載支持、JavaScript 遷移至 scope-based resolution (RFC #909)。修復項目包括 WAL corruption 偵測、FTS 驗證和修復機制、Git worktree 支持、多語言界面本地化（i18n）。新增 GitLab 倉庫支持和 DeepSeek V4 API 整合，此版本聚焦於多語言支持完善和資料庫穩定性提升。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.49)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.49 \n Target base: 1.6.6 (rc #49 )\n Source commit (main): eb69f66 \n Release commit (versioned tree): f942e35 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 feat: Support DeepSeek V4 API by @hugogu in #1594 
 test(cli): stabilize eval-server host checks by @hugogu in #1786 
 fix(php): avoid Blade templates entering PHP analysis by @Minidoracat in #1790 
 feat(cpp): Add structured resolver suppression outcomes by @azizur100389 in #1785 
 ...
 @Minidoracat made their first contribution in #1790 
 
 Full Changelog : v1.6.5...v1.6.6-rc.49
