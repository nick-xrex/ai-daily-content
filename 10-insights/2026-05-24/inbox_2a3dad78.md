...
id: inbox_2a3dad78
date: 2026-05-24
source_ref: "[[00-inbox/2026-05-24/0011-gitnexus-releases-release-candidate-v1-6-6-rc-50-746b]]"
title: "Release Candidate v1.6.6-rc.50"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.50
source: gitnexus-releases
published_at: 2026-05-24T09:14:10+00:00
fetched_at: 2026-05-25T00:14:49.435112+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.50 發布。內容與 rc.51–55 相同，包含 MCP 相容性改進、HTTP embedding 後端自部署、Swift 完整支援、Kotlin/PHP 等多語言、Docker、自動重索引、穩定性修正。屬自動化 CI 發布周期。"
key_points:
  - "MCP 相容性最佳化"
  - "HTTP embedding 後端自部署"
  - "多語言代碼分析擴展"
...
## Release Candidate v1.6.6-rc.50

GitNexus v1.6.6-rc.50 發布。內容與 rc.51–55 相同，包含 MCP 相容性改進、HTTP embedding 後端自部署、Swift 完整支援、Kotlin/PHP 等多語言、Docker、自動重索引、穩定性修正。屬自動化 CI 發布周期。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.50)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.50 \n Target base: 1.6.6 (rc #50 )\n Source commit (main): 39e9b40 \n Release commit (versioned tree): 9df06ea \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
