...
id: inbox_83c80557
date: 2026-05-24
source_ref: "[[00-inbox/2026-05-24/0011-gitnexus-releases-release-candidate-v1-6-6-rc-51-03b7]]"
title: "Release Candidate v1.6.6-rc.51"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.51
source: gitnexus-releases
published_at: 2026-05-24T11:30:50+00:00
fetched_at: 2026-05-25T00:14:49.434357+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.51 發布。變更清單與前四個 RC 版本完全相同，包含 MCP 相容性、HTTP embedding 後端、Swift/Kotlin 等多語言支援、Docker 容器化、自動重索引、bug 修正。屬連續自動化發布。"
key_points:
  - "MCP 啟動相容性與懶加載"
  - "HTTP embedding 自部署支援"
  - "多語言代碼分析涵蓋"
...
GitNexus v1.6.6-rc.51 發布。變更清單與前四個 RC 版本完全相同，包含 MCP 相容性、HTTP embedding 後端、Swift/Kotlin 等多語言支援、Docker 容器化、自動重索引、bug 修正。屬連續自動化發布。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.51)
