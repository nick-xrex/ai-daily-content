...
id: inbox_9807daa6
date: 2026-05-26
source_ref: "[[00-inbox/2026-05-26/2345-gitnexus-releases-release-candidate-v1-6-6-rc-72-3191]]"
title: "Release Candidate v1.6.6-rc.72"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.72
source: gitnexus-releases
published_at: 2026-05-26T19:47:12+00:00
fetched_at: 2026-05-27T23:52:03.961637+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.72 是一個重大的技術更新，標誌著代碼智能工具的基礎設施現代化與語言支援擴展。核心變化是資料庫遷移從 KuzuDB 轉向 LadybugDB v0.15，同時新增 HTTP embedding backend 支援自託管和遠端端點，以及完整的 Docker 容器化部署能力。型別解析系統進行多階段實現（Phase 4-9），支援可空型別展開、for-loop 型別推論、模式匹配、欄位/屬性型別解析等高級特性。語言涵蓋範圍擴大至 Swift、Kotlin、Ruby、PHP/Laravel、C/C++/C#/Rust 等，並支援 .gitignore 和 .gitnexusignore 優先序、git commit 後自動重新索引（保留 embeddings）。Bug 修復涵蓋 KuzuDB fork 崩潰、ENOTEMPTY 全域升級問題、大型倉庫的解析快取分片等。"
key_points:
  - "資料庫遷移 KuzuDB→LadybugDB v0.15，HTTP embedding backend 支援自託管/遠端端點，Docker 容器化部署"
  - "多階段型別解析系統（Phase 4-9）：可空型別展開、for-loop 型別推論、模式匹配、欄位/屬性型別解析、ACCESSES edge tracking"
  - "語言擴展至 Swift/Kotlin/Ruby/PHP+Laravel/C/C++/C#/Rust；.gitignore/.gitnexusignore 支援；git commit 自動重新索引"
tags: [gitnexus-release, type-resolution, embeddings-backend, multi-language-support, database-migration]
topics: [agents.mcp]
importance: 4
novelty: 4
insight_quality: 4
...
## Release Candidate v1.6.6-rc.72

GitNexus v1.6.6-rc.72 是一個重大的技術更新，標誌著代碼智能工具的基礎設施現代化與語言支援擴展。核心變化是資料庫遷移從 KuzuDB 轉向 LadybugDB v0.15，同時新增 HTTP embedding backend 支援自託管和遠端端點，以及完整的 Docker 容器化部署能力。型別解析系統進行多階段實現（Phase 4-9），支援可空型別展開、for-loop 型別推論、模式匹配、欄位/屬性型別解析等高級特性。語言涵蓋範圍擴大至 Swift、Kotlin、Ruby、PHP/Laravel、C/C++/C#/Rust 等，並支援 .gitignore 和 .gitnexusignore 優先序、git commit 後自動重新索引（保留 embeddings）。Bug 修復涵蓋 KuzuDB fork 崩潰、ENOTEMPTY 全域升級問題、大型倉庫的解析快取分片等。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.72)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.72 \n Target base: 1.6.6 (rc #72 )\n Source commit (main): d903152 \n Release commit (versioned tree): 46f819f \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
