...
id: inbox_aded27ae
date: 2026-04-30
source_ref: "[[00-inbox/2026-04-30/1800-hermes-agent-releases-hermes-agent-v0-12-0-2026-4-30-c4d1]]"
title: "Hermes Agent v0.12.0 (2026.4.30)"
...
fetched_at: 2026-05-22T18:08:46.114431+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "Hermes Agent v0.12.0 The Curator Release（1,096 commits、217,776 insertions）首次引入 Autonomous Curator agent，在背景每 7 天自動評級、清理、整合 skill library 並產生 REPORT.md。Self-improvement loop 大幅升級為 rubric-based 評分、active-update bias、reference 子檔處理。基礎設施擴展：ComfyUI v5、TouchDesigner-MCP 捆綁預設，LM Studio 升一級提供商，新增 4 個推理提供商（GMI Cloud、Azure AI Foundry、MiniMax、Tencent Tokenhub）。平台新增騰訊元寶 (Yuanbao) 第 18 平台，Spotify/Google Meet 原生整合，TUI 冷啟動 ~57% 減少，prompt cache TTL 可配置。"
key_points:
  - "Autonomous Curator pattern：background agent 自動評級、去重、歸檔 skills，rubric-based 而非自由文本，省人力維護"
  - "Self-improvement loop 升級：active-update bias + reference 子檔支援 + parent runtime 繼承，讓 agent 自我精進能力更強"
  - "4 新推理提供商 + Spotify/Google Meet 原生支援展示 provider 生態快速擴張"
tags: [skill-curation, self-improvement, rubric-based-grading, inference-providers, performance-optimization]
topics: []
importance: 4
novelty: 4
insight_quality: 5
...
**原文：** [hermes-agent-releases](https://github.com/NousResearch/hermes-agent/releases/tag/v2026.4.30)
