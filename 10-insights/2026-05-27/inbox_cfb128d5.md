...
id: inbox_cfb128d5
date: 2026-05-27
source_ref: "[[00-inbox/2026-05-27/2345-gitnexus-releases-release-candidate-v1-6-6-rc-75-7c00]]"
title: "Release Candidate v1.6.6-rc.75"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.75
source: gitnexus-releases
published_at: 2026-05-27T08:55:57+00:00
fetched_at: 2026-05-27T23:49:52.866394+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.75 候選版本發布，changelog 與 rc.76 相同（連續 RC 快照）。包含完整 Swift/iOS 支援、PHP/Laravel Eloquent 追蹤、Docker 支持、HTTP embedding backend、LadybugDB v0.15 遷移、9 階段型別解析框架覆蓋 10+ 語言（PHP、Ruby、Swift、Kotlin、C/C++/C#/Rust）、ACCESSES edge 讀寫追蹤、象徵解析與型別推論強化、MCP startup 加固、KuzuDB fork crash 修復、並行工具 crash 修復。"
key_points:
  - "LadybugDB 遷移、HTTP embedding backend 自託管支持、型別解析 9 階段框架（10+ 語言覆蓋）"
  - "多語言強化：Swift/iOS、PHP/Laravel、Ruby、Kotlin、C/C++/C#/Rust，象徵解析、型別推論、模式匹配、ACCESSES 讀寫追蹤"
  - "MCP startup 加固、KuzuDB fork crash 修復、並行工具 crash 修復"
...
## Release Candidate v1.6.6-rc.75

GitNexus v1.6.6-rc.75 候選版本發布，changelog 與 rc.76 相同（連續 RC 快照）。包含完整 Swift/iOS 支援、PHP/Laravel Eloquent 追蹤、Docker 支持、HTTP embedding backend、LadybugDB v0.15 遷移、9 階段型別解析框架覆蓋 10+ 語言（PHP、Ruby、Swift、Kotlin、C/C++/C#/Rust）、ACCESSES edge 讀寫追蹤、象徵解析與型別推論強化、MCP startup 加固、KuzuDB fork crash 修復、並行工具 crash 修復。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.75)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.75 \n Target base: 1.6.6 (rc #75 )\n Source commit (main): 46eb0eb \n Release commit (versioned tree): 6eab44d \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
