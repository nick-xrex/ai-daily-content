...
id: inbox_710d1e29
date: 2026-06-16
source_ref: "[[00-inbox/2026-06-16/2200-gitnexus-releases-release-candidate-v1-6-8-rc-43-b07a]]"
title: "Release Candidate v1.6.8-rc.43"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.43
source: gitnexus-releases
published_at: 2026-06-16T04:22:48+00:00
fetched_at: 2026-06-16T22:05:38.014298+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 1.6.8-rc.43 是 1.6.8 的早期預發布版本。涵蓋 CFG/PDG 分析層、污點分析功能、MCP 伺服器改進與 40+ 項修復。相較後續 rc.44，缺少 Ferrante CDG 控制依賴分析、倉庫同步群組修正、最新效能優化（PDG 串流式發射、SSA 稀疏達定義、graph-DB 效能），但保留 CFG/PDG 與污點分析核心功能。"
key_points:
  - "CFG/PDG 分析層支援多語言程式碼結構化分析"
  - "污點分析涵蓋過程內與過程間追蹤，MCP 查詢參數重命名確保 Claude Code 相容"
tags: [code-analysis, control-flow-graph, taint-analysis, release-candidate]
topics: []
importance: 3
novelty: 3
insight_quality: 3
...
## Release Candidate v1.6.8-rc.43

GitNexus 1.6.8-rc.43 是 1.6.8 的早期預發布版本。涵蓋 CFG/PDG 分析層、污點分析功能、MCP 伺服器改進與 40+ 項修復。相較後續 rc.44，缺少 Ferrante CDG 控制依賴分析、倉庫同步群組修正、最新效能優化（PDG 串流式發射、SSA 稀疏達定義、graph-DB 效能），但保留 CFG/PDG 與污點分析核心功能。

### 重點
- CFG/PDG 分析層支援多語言程式碼結構化分析
- 污點分析涵蓋過程內與過程間追蹤，MCP 查詢參數重命名確保 Claude Code 相容

**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.43)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.43 \n Target base: 1.6.8 (rc #43 )\n Source commit (main): 3c82361 \n Release commit (versioned tree): e3420f6 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.43
