...
id: inbox_9490ddfd
date: 2026-06-16
source_ref: "[[00-inbox/2026-06-16/2200-gitnexus-releases-release-candidate-v1-6-8-rc-44-d6bc]]"
title: "Release Candidate v1.6.8-rc.44"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.44
source: gitnexus-releases
published_at: 2026-06-16T05:09:31+00:00
fetched_at: 2026-06-16T22:05:38.009283+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 1.6.8-rc.44 是功能豐富的預發布版本，包含重大程式分析功能升級。新增多分支索引與分支範圍查詢、多語言支援的控制流程圖（CFG）與程式依賴圖（PDG）分析層、過程內與過程間污點追蹤分析。MCP HTTP 伺服器新增支援，並推出追蹤符號最短呼叫路徑工具。效能面向導入 SSA 稀疏達定義分析、PDG 串流式分塊發射優化內核規模倉庫、graph-DB 發射牆時間優化。新增 Java Spring 路由註解提取、循環匯入檢測，GitHub 私人倉庫（PAT）與 Azure DevOps Server 支援。此版本 50+ PR、5 位新貢獻者。"
key_points:
  - "多分支索引與 PDG/CFG 分析層支援 TS/JS/Java，涵蓋過程內外污點分析"
  - "SSA 稀疏達定義分析（SSA-sparse reaching-defs）取代密集集合工作表，流式 PDG 圖表輸出支援內核規模倉庫"
  - "MCP HTTP 伺服器（Streamable HTTP + SSE）新增符號間最短路徑追蹤工具，GitHub PAT + Azure DevOps Server 支援"
tags: [code-analysis, program-dependence-graph, taint-analysis, control-flow-graph, mcp-server]
topics: []
importance: 4
novelty: 4
insight_quality: 4
...
## Release Candidate v1.6.8-rc.44

GitNexus 1.6.8-rc.44 是功能豐富的預發布版本，包含重大程式分析功能升級。新增多分支索引與分支範圍查詢、多語言支援的控制流程圖（CFG）與程式依賴圖（PDG）分析層、過程內與過程間污點追蹤分析。MCP HTTP 伺服器新增支援，並推出追蹤符號最短呼叫路徑工具。效能面向導入 SSA 稀疏達定義分析、PDG 串流式分塊發射優化內核規模倉庫、graph-DB 發射牆時間優化。新增 Java Spring 路由註解提取、循環匯入檢測，GitHub 私人倉庫（PAT）與 Azure DevOps Server 支援。此版本 50+ PR、5 位新貢獻者。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.44)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.44 \n Target base: 1.6.8 (rc #44 )\n Source commit (main): 7d12ea8 \n Release commit (versioned tree): 5990b6c \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.44
