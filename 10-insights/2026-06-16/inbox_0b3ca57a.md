...
id: inbox_0b3ca57a
date: 2026-06-16
source_ref: "[[00-inbox/2026-06-16/2200-gitnexus-releases-release-candidate-v1-6-8-rc-45-2926]]"
title: "Release Candidate v1.6.8-rc.45"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.45
source: gitnexus-releases
published_at: 2026-06-16T05:43:27+00:00
fetched_at: 2026-06-16T22:04:45.510383+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.8-rc.45 發布，包含 47 項改進（相比 rc.48 缺少 CUDA 語法解析與圖 COPY 重疊最佳化）。新增功能涵蓋：Java Spring 路由註解抽取、多分支索引與分支作用域查詢、控制流圖層（TS/JS）、過程內與跨過程污點分析、運達定義數據依賴層、後支配與控制依賴圖、MCP HTTP 伺服器、最短呼叫路徑追蹤工具、私有 GitHub + Azure DevOps 支援。修復項包括：VECTOR 索引、Docker 資產、大倉庫解析、爆炸半徑估計、WebUI 卡頓、儲存體登錄誤清除等。效能改進：PDG/CFG 流式發射、SSA 稀疏運達定義、圖資料庫發射時間縮減。"
key_points:
  - "新增跨過程污點分析與控制流圖層，增強靜態代碼分析深度（TS/JS/C++ 等多語言）"
  - "支援多分支索引、分支作用域查詢、私有 GitHub repos + Azure DevOps Server，提升企業集成能力"
  - "47 項改進包括 PDG/CFG 流式發射、SSA 稀疏算法、圖資料庫發射時間優化，改善超大倉庫分析效能"
...
## Release Candidate v1.6.8-rc.45

GitNexus v1.6.8-rc.45 發布，包含 47 項改進（相比 rc.48 缺少 CUDA 語法解析與圖 COPY 重疊最佳化）。新增功能涵蓋：Java Spring 路由註解抽取、多分支索引與分支作用域查詢、控制流圖層（TS/JS）、過程內與跨過程污點分析、運達定義數據依賴層、後支配與控制依賴圖、MCP HTTP 伺服器、最短呼叫路徑追蹤工具、私有 GitHub + Azure DevOps 支援。修復項包括：VECTOR 索引、Docker 資產、大倉庫解析、爆炸半徑估計、WebUI 卡頓、儲存體登錄誤清除等。效能改進：PDG/CFG 流式發射、SSA 稀疏運達定義、圖資料庫發射時間縮減。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.45)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.45 \n Target base: 1.6.8 (rc #45 )\n Source commit (main): 4c7e066 \n Release commit (versioned tree): 9ec424a \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.45
