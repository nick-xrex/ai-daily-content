...
id: inbox_f914223d
date: 2026-07-11
source_ref: "[[00-inbox/.../inbox_f914223d]]"
title: "Release Candidate v1.6.10-rc.18"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.18
source: gitnexus-releases
published_at: 2026-07-11T10:58:01+00:00
fetched_at: 2026-07-13T00:59:00.098538+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.18 是第 18 个自动化发布候选版本，继续面向 v1.6.10 稳定版的预发布周期。该版本包含 CodeBuddy 和 Qoder 编码代理集成以及完整的 OpenAI Codex 支持，引入 hooks 和 plugin marketplace 等新功能。版本共包含约 17 个修复，主要涉及代理阻隔安装恢复和嵌入自愈、FTS 扩展加载错误诊断、MCP 符号内容和行号精确性修复、Windows FTS 依赖缺失诊断、自定义嵌入端点失败报告、服务器 repo 路径解析和克隆目录所有权检查、FastAPI 路由常量解析、Windows 跨平台 CI 超时修复等改进。其他重要修复涉及增量脏状态诊断，用于帮助用户理解仓库在线增量构建的当前状态。这个版本体现了对平台兼容性和编码代理功能的持续优化。"
key_points:
  - "CodeBuddy 和 Qoder 编码代理集成及完整 Codex 支持（hooks、plugin marketplace）"
  - "Windows 和多平台稳定性改进：FTS 依赖诊断（#2383）、repo 路径解析、克隆目录所有权检查（#2387）、跨平台 CI 超时处理"
  - "MCP 和嵌入系统修复：符号内容精确性修复、自定义端点错误报告（#2385/2386）、增量脏状态诊断"
tags: [gitnexus, release-candidate, codex-integration, windows-stability, mcp]
topics: []
importance: 4
novelty: 3
insight_quality: 2
...
## Release Candidate v1.6.10-rc.18

GitNexus v1.6.10-rc.18 是第 18 个自动化发布候选版本，继续面向 v1.6.10 稳定版的预发布周期。该版本包含 CodeBuddy 和 Qoder 编码代理集成以及完整的 OpenAI Codex 支持，引入 hooks 和 plugin marketplace 等新功能。版本共包含约 17 个修复，主要涉及代理阻隔安装恢复和嵌入自愈、FTS 扩展加载错误诊断、MCP 符号内容和行号精确性修复、Windows FTS 依赖缺失诊断、自定义嵌入端点失败报告、服务器 repo 路径解析和克隆目录所有权检查、FastAPI 路由常量解析、Windows 跨平台 CI 超时修复等改进。其他重要修复涉及增量脏状态诊断，用于帮助用户理解仓库在线增量构建的当前状态。这个版本体现了对平台兼容性和编码代理功能的持续优化。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.18)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.18 \n Target base: 1.6.10 (rc #18 )\n Source commit (main): 737a8cd \n Release commit (versioned tree): 5bb03fa \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.18
