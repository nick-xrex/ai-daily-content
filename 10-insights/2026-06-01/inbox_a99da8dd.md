...
id: inbox_a99da8dd
date: 2026-06-01
source_ref: "[[00-inbox/2026-06-01/2245-gitnexus-releases-release-candidate-v1-6-6-rc-108-a111]]"
title: "Release Candidate v1.6.6-rc.108"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.108
source: gitnexus-releases
published_at: 2026-06-01T12:42:48+00:00
fetched_at: 2026-06-01T22:49:58.996832+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.108 發布候選版本。功能與安全增強包括 MCP startup 兼容性改進、CLI lazy-load、git commit 自動 reindex 保留 embeddings、HTTP embedding backend、完整 Swift 語言支援、Docker 支援。Bug fix 涵蓋 preinstall cleanup、cache dir、parse cache 分片。效能改進消除 scope-capture O(n²)。"
key_points:
  - "Git hook 自動化：commit 後 reindex 保留 embedding，無須手動觸發"
  - "Swift、Docker、HTTP 遠端 embedding 等多語言與基礎設施擴展"
  - "O(n²) scope-capture 消除提升大型 repo 解析效能"
...
## Release Candidate v1.6.6-rc.108

GitNexus v1.6.6-rc.108 發布候選版本。功能與安全增強包括 MCP startup 兼容性改進、CLI lazy-load、git commit 自動 reindex 保留 embeddings、HTTP embedding backend、完整 Swift 語言支援、Docker 支援。Bug fix 涵蓋 preinstall cleanup、cache dir、parse cache 分片。效能改進消除 scope-capture O(n²)。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.108)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.108 \n Target base: 1.6.6 (rc #108 )\n Source commit (main): fca30c7 \n Release commit (versioned tree): 7dd2847 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
