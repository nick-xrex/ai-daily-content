...
id: inbox_7f9aec96
date: 2026-06-01
source_ref: "[[00-inbox/2026-06-01/2245-gitnexus-releases-release-candidate-v1-6-6-rc-109-111f]]"
title: "Release Candidate v1.6.6-rc.109"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.109
source: gitnexus-releases
published_at: 2026-06-01T16:29:07+00:00
fetched_at: 2026-06-01T22:49:58.995176+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.109 發布候選版本。安全性上，MCP startup 兼容性改進、CLI 指令 lazy-load。功能面，auto-reindex 保留 embeddings、HTTP embedding backend、完整 Swift 語言支援、Docker 支援。Bug fix 包括 preinstall cleanup、cache dir 改為使用者可寫、parse cache 分片。效能方面消除 Go scope-capture O(n²)。"
key_points:
  - "Git commit 自動 reindex 並保留 embedding，無須手動觸發索引更新"
  - "多語言支援擴展：Swift、Docker、HTTP 遠端 embedding backend"
  - "O(n²) scope-capture 消除、preinstall cleanup、大 repo parse cache 分片優化"
tags: [gitnexus, release-candidate, embeddings, docker, swift, mcp]
topics: [agents.mcp]
importance: 3
novelty: 2
insight_quality: 1
...
## Release Candidate v1.6.6-rc.109

GitNexus v1.6.6-rc.109 發布候選版本。安全性上，MCP startup 兼容性改進、CLI 指令 lazy-load。功能面，auto-reindex 保留 embeddings、HTTP embedding backend、完整 Swift 語言支援、Docker 支援。Bug fix 包括 preinstall cleanup、cache dir 改為使用者可寫、parse cache 分片。效能方面消除 Go scope-capture O(n²)。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.109)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.109 \n Target base: 1.6.6 (rc #109 )\n Source commit (main): 0fc0211 \n Release commit (versioned tree): a483af6 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
