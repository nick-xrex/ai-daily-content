...
id: inbox_fc9b754d
date: 2026-05-22
source_ref: "[[00-inbox/2026-05-22/1800-gitnexus-releases-release-candidate-v1-6-6-rc-43-7b26]]"
title: "Release Candidate v1.6.6-rc.43"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.43
source: gitnexus-releases
published_at: 2026-05-22T14:13:34+00:00
fetched_at: 2026-05-22T18:04:55.077581+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.43 發布，包含語言、性能和穩定性的重大改進。新增功能：Kotlin scope resolver、JavaScript scope-based resolution 遷移（RFC #909）、C++ SFINAE 過濾和重載運算符解析、GitLab 倉庫支持。性能優化：自動堆積提升至 16GB（支持 UE5 規模倉庫）、owner-keyed lookup 加速 Step 2 成員解析、零複製 ingestion worker 池。穩定性：WAL 損毀檢測和復原、FTS 驗證、Windows EPERM 修復、Git worktrees 支持。"
key_points:
  - "新增 Kotlin/JavaScript/C++ 語言支持，Git worktrees 和 GitLab 倉庫支持"
  - "記憶體優化至 16GB；owner-keyed lookup 加速成員解析性能"
  - "WAL 損毀偵測、FTS 驗證、Cypher 讀寫控制等穩定性強化"
tags: [gitnexus, kotlin, javascript, cpp, performance-tuning, stability]
topics: []
importance: 3
novelty: 2
insight_quality: 2
...
## Release Candidate v1.6.6-rc.43

GitNexus v1.6.6-rc.43 發布，包含語言、性能和穩定性的重大改進。新增功能：Kotlin scope resolver、JavaScript scope-based resolution 遷移（RFC #909）、C++ SFINAE 過濾和重載運算符解析、GitLab 倉庫支持。性能優化：自動堆積提升至 16GB（支持 UE5 規模倉庫）、owner-keyed lookup 加速 Step 2 成員解析、零複製 ingestion worker 池。穩定性：WAL 損毀檢測和復原、FTS 驗證、Windows EPERM 修復、Git worktrees 支持。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.43)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.43 \n Target base: 1.6.6 (rc #43 )\n Source commit (main): 87b91c8 \n Release commit (versioned tree): 05c5cf8 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.5...v1.6.6-rc.43
