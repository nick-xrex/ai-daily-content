...
id: inbox_54bdf029
date: 2026-05-22
source_ref: "[[00-inbox/2026-05-22/1800-gitnexus-releases-release-candidate-v1-6-6-rc-37-3c10]]"
title: "Release Candidate v1.6.6-rc.37"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.37
source: gitnexus-releases
published_at: 2026-05-22T05:48:26+00:00
fetched_at: 2026-05-22T18:06:42.964138+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.37 預發行版本（main 分支 be3833d），npm install gitnexus@rc。包含 JavaScript scope-based resolution 遷移（RFC #909）、C++ SFINAE 過濾和 type_traits 擴展、Java 同模組 FQN 優先解析、Kotlin scope resolver 新增。新功能支持 Git worktrees 代碼檢測、多語言 wiki 生成（--lang 旗標）、GitLab 倉庫支援。修復涵蓋 WAL 損壞檢測與復原、Windows FTS 探測載入、eval-server 主機 IP 自訂（--host）、Ladybug 只讀執行和 Cypher prepared statement。分析堆提升至 16GB 用於 UE5 級大規模倉庫。相比 rc.39，缺少最新的 Kotlin 方法解析細化修復。"
key_points:
  - "JavaScript scope-based resolution、Kotlin scope resolver、C++ SFINAE 過濾和型別特徵擴展"
  - "Git worktrees、多語言 wiki --lang、GitLab 倉庫、WAL 損壞檢測與復原"
  - "分析堆 16GB、Windows FTS 探測、eval-server --host、Ladybug 只讀執行、Cypher prepared statement"
...
## Release Candidate v1.6.6-rc.37

GitNexus v1.6.6-rc.37 預發行版本（main 分支 be3833d），npm install gitnexus@rc。包含 JavaScript scope-based resolution 遷移（RFC #909）、C++ SFINAE 過濾和 type_traits 擴展、Java 同模組 FQN 優先解析、Kotlin scope resolver 新增。新功能支持 Git worktrees 代碼檢測、多語言 wiki 生成（--lang 旗標）、GitLab 倉庫支援。修復涵蓋 WAL 損壞檢測與復原、Windows FTS 探測載入、eval-server 主機 IP 自訂（--host）、Ladybug 只讀執行和 Cypher prepared statement。分析堆提升至 16GB 用於 UE5 級大規模倉庫。相比 rc.39，缺少最新的 Kotlin 方法解析細化修復。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.37)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.37 \n Target base: 1.6.6 (rc #37 )\n Source commit (main): be3833d \n Release commit (versioned tree): b9b4db1 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.5...v1.6.6-rc.37
