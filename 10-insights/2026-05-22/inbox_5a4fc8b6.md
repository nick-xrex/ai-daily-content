...
id: inbox_5a4fc8b6
date: 2026-05-22
source_ref: "[[00-inbox/2026-05-22/1800-gitnexus-releases-release-candidate-v1-6-6-rc-35-1aeb]]"
title: "Release Candidate v1.6.6-rc.35"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.35
source: gitnexus-releases
published_at: 2026-05-22T04:08:50+00:00
fetched_at: 2026-05-22T18:06:42.965984+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.35 預發行版本（main 分支 8c1983a），自動化構建，npm install gitnexus@rc。包含 JavaScript scope-based resolution 遷移、Kotlin scope resolver、C++ SFINAE 和 type_traits 強化、Java 同模組 FQN 優先解析。功能支持 Git worktrees、多語言 wiki（--lang）、GitLab 倉庫。修復包括 WAL 損壞檢測與復原、Windows 兼容性、eval-server 主機設定、Ladybug 只讀執行。分析堆提升至 16GB。作為 1.6.6 系列早期 RC，功能集與後續版本相同。"
key_points:
  - "JavaScript scope-based resolution、Kotlin scope resolver、C++ SFINAE 過濾和型別特徵"
  - "Git worktrees 支持、多語言 wiki、GitLab 倉庫、WAL 損壞檢測"
  - "分析堆 16GB、Windows FTS 探測、eval-server --host、Ladybug 只讀執行"
...
## Release Candidate v1.6.6-rc.35

GitNexus v1.6.6-rc.35 預發行版本（main 分支 8c1983a），自動化構建，npm install gitnexus@rc。包含 JavaScript scope-based resolution 遷移、Kotlin scope resolver、C++ SFINAE 和 type_traits 強化、Java 同模組 FQN 優先解析。功能支持 Git worktrees、多語言 wiki（--lang）、GitLab 倉庫。修復包括 WAL 損壞檢測與復原、Windows 兼容性、eval-server 主機設定、Ladybug 只讀執行。分析堆提升至 16GB。作為 1.6.6 系列早期 RC，功能集與後續版本相同。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.35)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.35 \n Target base: 1.6.6 (rc #35 )\n Source commit (main): 8c1983a \n Release commit (versioned tree): 33ef3a9 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.5...v1.6.6-rc.35
