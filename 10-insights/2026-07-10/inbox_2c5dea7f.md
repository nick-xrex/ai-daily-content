...
id: inbox_2c5dea7f
date: 2026-07-10
source_ref: "[[00-inbox/.../inbox_2c5dea7f]]"
title: "Release Candidate v1.6.10-rc.14"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.14
source: gitnexus-releases
published_at: 2026-07-10T13:19:40+00:00
fetched_at: 2026-07-11T01:54:18.524758+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.14（Release Candidate）是 rc.15 之前的中間版本，共同涵蓋 Codex 全整合（hooks、plugin marketplace、setup）、CodeBuddy/Qoder 編碼 agent 支援、Proxy-blocked 環境 self-heal、FTS extension 診斷、MCP symbol content 精確定位、Windows FTS 依賴檢查、HTTP embedding endpoint 錯誤報告、FastAPI 路由常數解析、跨平台 CI timeout 修復、MCP query hint DB lock 檢測等改進。相比 rc.15，缺少大型增量 writeback 可靠性改進（#2425）和 CLI 診斷改進（#2424）。"
key_points:
  - "Codex 整合與 CodeBuddy/Qoder agent 支援已完備"
  - "MCP symbol 精確定位與 DB lock 查詢提示機制完整"
  - "Proxy/FTS/embedding endpoint 自癒流程已納入"
...
## Release Candidate v1.6.10-rc.14

GitNexus v1.6.10-rc.14（Release Candidate）是 rc.15 之前的中間版本，共同涵蓋 Codex 全整合（hooks、plugin marketplace、setup）、CodeBuddy/Qoder 編碼 agent 支援、Proxy-blocked 環境 self-heal、FTS extension 診斷、MCP symbol content 精確定位、Windows FTS 依賴檢查、HTTP embedding endpoint 錯誤報告、FastAPI 路由常數解析、跨平台 CI timeout 修復、MCP query hint DB lock 檢測等改進。相比 rc.15，缺少大型增量 writeback 可靠性改進（#2425）和 CLI 診斷改進（#2424）。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.14)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.14 \n Target base: 1.6.10 (rc #14 )\n Source commit (main): df1fc36 \n Release commit (versioned tree): 33de036 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.14
