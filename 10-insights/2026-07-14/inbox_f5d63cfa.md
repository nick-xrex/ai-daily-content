...
id: inbox_f5d63cfa
date: 2026-07-14
source_ref: "[[00-inbox/2026-07-14/2200-gitnexus-releases-release-candidate-v1-6-10-rc-22-7c50]]"
title: "Release Candidate v1.6.10-rc.22"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.22
source: gitnexus-releases
published_at: 2026-07-14T12:11:00+00:00
fetched_at: 2026-07-14T22:05:16.059283+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.22 RC 版本發布。新增功能包括 CodeBuddy 和 Qoder coding-agent 集成、完整 Codex 支持（hooks、plugin marketplace、setup）。本版本包含多項 bug fixes，涵蓋 proxy-blocked installs 恢復、FTS 擴展 LOAD 錯誤、MCP 符號內容精確度、Windows FTS 依賴診斷、FastAPI 路由路徑常數等領域的改善。"
key_points:
  - "CodeBuddy 和 Qoder coding-agent 集成"
  - "完整 Codex 支持（hooks、plugin marketplace）"
  - "多項 bug fixes：proxy-blocked installs self-heal、FTS/MCP 錯誤處理、Windows 平台依賴診斷"
...
## Release Candidate v1.6.10-rc.22

GitNexus v1.6.10-rc.22 RC 版本發布。新增功能包括 CodeBuddy 和 Qoder coding-agent 集成、完整 Codex 支持（hooks、plugin marketplace、setup）。本版本包含多項 bug fixes，涵蓋 proxy-blocked installs 恢復、FTS 擴展 LOAD 錯誤、MCP 符號內容精確度、Windows FTS 依賴診斷、FastAPI 路由路徑常數等領域的改善。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.22)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.22 \n Target base: 1.6.10 (rc #22 )\n Source commit (main): 9cc3647 \n Release commit (versioned tree): 2141897 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.22
