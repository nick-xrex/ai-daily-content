...
id: inbox_1d8583fd
date: 2026-07-14
source_ref: "[[00-inbox/2026-07-14/2200-gitnexus-releases-release-candidate-v1-6-10-rc-21-9c38]]"
title: "Release Candidate v1.6.10-rc.21"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.21
source: gitnexus-releases
published_at: 2026-07-14T04:10:13+00:00
fetched_at: 2026-07-14T22:05:16.073384+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.21 RC 版本發布。新增功能包括 CodeBuddy 和 Qoder coding-agent 集成、完整 Codex 支持（hooks、plugin marketplace、setup）。本版本包含多項 bug fixes 與穩定性改善，涉及多個領域的問題修復。"
key_points:
  - "CodeBuddy 和 Qoder coding-agent 集成"
  - "完整 Codex 支持（hooks、plugin marketplace、setup）"
  - "多項 bug fixes 與穩定性改善"
...
## Release Candidate v1.6.10-rc.21

GitNexus v1.6.10-rc.21 RC 版本發布。新增功能包括 CodeBuddy 和 Qoder coding-agent 集成、完整 Codex 支持（hooks、plugin marketplace、setup）。本版本包含多項 bug fixes 與穩定性改善，涉及多個領域的問題修復。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.21)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.21 \n Target base: 1.6.10 (rc #21 )\n Source commit (main): 1482c0b \n Release commit (versioned tree): 45ebe00 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.21
