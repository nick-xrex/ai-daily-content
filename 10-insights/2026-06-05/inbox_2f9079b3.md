...
id: inbox_2f9079b3
date: 2026-06-05
source_ref: "[[00-inbox/2026-06-05/1800-gitnexus-releases-release-candidate-v1-6-6-rc-144-050b]]"
title: "Release Candidate v1.6.6-rc.144"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.144
source: gitnexus-releases
published_at: 2026-06-05T03:45:47+00:00
fetched_at: 2026-06-05T18:05:41.391164+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.144 發布。新增 Swift 完整支援（查詢修正、匯出檢測、隱式 import、constructor 解析）、HTTP 嵌入後端支援自主託管端點、Docker 容器支援、及自動重新索引功能。效能改進包括 Go 語言的 O(n²) scope-capture re-walk 消除。安全增強包括 MCP 啟動相容性改進和 CLI 命令延遲載入。此版本修復全域升級 ENOTEMPTY 錯誤、大型倉庫的快取持久化分片問題。"
key_points:
  - "新增 Swift 完整支援（SPM import 解析、constructor 辨別、隱式 import）"
  - "HTTP 嵌入後端用於自主託管/遠端端點整合"
  - "Docker 支援及自動重新索引功能（保留嵌入）、O(n²) Go scope-capture 效能修復"
tags: [gitnexus, code-intelligence, swift-support, embeddings, mcp]
topics: []
importance: 1
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.144

GitNexus v1.6.6-rc.144 發布。新增 Swift 完整支援（查詢修正、匯出檢測、隱式 import、constructor 解析）、HTTP 嵌入後端支援自主託管端點、Docker 容器支援、及自動重新索引功能。效能改進包括 Go 語言的 O(n²) scope-capture re-walk 消除。安全增強包括 MCP 啟動相容性改進和 CLI 命令延遲載入。此版本修復全域升級 ENOTEMPTY 錯誤、大型倉庫的快取持久化分片問題。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.144)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.144 \n Target base: 1.6.6 (rc #144 )\n Source commit (main): 93e04b4 \n Release commit (versioned tree): 6501153 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
