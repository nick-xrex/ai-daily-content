...
id: inbox_ef233861
date: 2026-07-17
source_ref: "[[00-inbox/.../inbox_ef233861]]"
title: "Release Candidate v1.6.10-rc.44"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.44
source: gitnexus-releases
published_at: 2026-07-17T13:30:05+00:00
fetched_at: 2026-07-18T01:43:24.335734+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.44 於 2026 年 7 月 17 日 13:30 UTC 發佈，是 RC 版本系列的第五個版本。功能集聚焦 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、編碼代理整合（CodeBuddy、Qoder）、完整 Codex 支持（hooks、插件市場、安裝流程）、embeddings 和 FTS 自癒、Windows 平台穩定（FTS 診斷、Napi SIGABRT 修復、符號索引映射）。快取/CLI/嵌入系列提供 HTTP 可恢復性、批量插入重試安全、文本承載回退、樹 sitter 恢復。本版本與 rc.40-43 功能保持一致。npm 安裝指令：npm install gitnexus@rc。"
key_points:
...
## Release Candidate v1.6.10-rc.44

GitNexus v1.6.10-rc.44 於 2026 年 7 月 17 日 13:30 UTC 發佈，是 RC 版本系列的第五個版本。功能集聚焦 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、編碼代理整合（CodeBuddy、Qoder）、完整 Codex 支持（hooks、插件市場、安裝流程）、embeddings 和 FTS 自癒、Windows 平台穩定（FTS 診斷、Napi SIGABRT 修復、符號索引映射）。快取/CLI/嵌入系列提供 HTTP 可恢復性、批量插入重試安全、文本承載回退、樹 sitter 恢復。本版本與 rc.40-43 功能保持一致。npm 安裝指令：npm install gitnexus@rc。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.44)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.44 \n Target base: 1.6.10 (rc #44 )\n Source commit (main): 3c36ab9 \n Release commit (versioned tree): d95cfeb \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.44
