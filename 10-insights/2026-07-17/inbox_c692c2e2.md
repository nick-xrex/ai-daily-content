...
id: inbox_c692c2e2
date: 2026-07-17
source_ref: "[[00-inbox/.../inbox_c692c2e2]]"
title: "Release Candidate v1.6.10-rc.39"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.39
source: gitnexus-releases
published_at: 2026-07-17T03:45:04+00:00
fetched_at: 2026-07-18T01:46:16.468043+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.39 釋出，加入 CodeBuddy 和 Qoder 編程代理整合與完整 Codex 支援（含 hooks、插件市場）。引入 embeddings 自我修復機制應對代理阻擋的安裝環境。MCP 政策系列包括決定論回應預算、fail-closed 唯讀模式、倉庫白名單、0-based 行儲存與 1-based MCP 顯示對齊。修復逾 40 項問題，包括樹狀搜尋器 NUL 位元組恢復、Windows FTS 依賴診斷、HTTP embeddings 端點錯誤回報。"
key_points:
  - "CodeBuddy、Qoder 編程代理整合 + 完整 Codex 支援（hooks、插件市場、設置配置）"
  - "MCP 政策系列：決定論回應預算、fail-closed 唯讀模式、倉庫白名單、0-based vs 1-based 行儲存對齳"
  - "超過 40 項修復：embeddings 自我修復、Windows FTS 診斷、HTTP 端點錯誤回報、hook 會話管理"
tags: [gitnexus, mcp-integration, codex-support, embeddings-resilience, determinism]
topics: [agents.mcp]
importance: 3
novelty: 3
insight_quality: 3
...
## Release Candidate v1.6.10-rc.39

GitNexus v1.6.10-rc.39 釋出，加入 CodeBuddy 和 Qoder 編程代理整合與完整 Codex 支援（含 hooks、插件市場）。引入 embeddings 自我修復機制應對代理阻擋的安裝環境。MCP 政策系列包括決定論回應預算、fail-closed 唯讀模式、倉庫白名單、0-based 行儲存與 1-based MCP 顯示對齊。修復逾 40 項問題，包括樹狀搜尋器 NUL 位元組恢復、Windows FTS 依賴診斷、HTTP embeddings 端點錯誤回報。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.39)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.39 \n Target base: 1.6.10 (rc #39 )\n Source commit (main): 91955e6 \n Release commit (versioned tree): 7a803e8 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.39
