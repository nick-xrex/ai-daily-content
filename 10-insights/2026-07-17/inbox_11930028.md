...
id: inbox_11930028
date: 2026-07-17
source_ref: "[[00-inbox/.../inbox_11930028]]"
title: "Release Candidate v1.6.10-rc.43"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.43
source: gitnexus-releases
published_at: 2026-07-17T12:56:45+00:00
fetched_at: 2026-07-18T01:43:24.336999+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.43 於 2026 年 7 月 17 日 12:56 UTC 發佈，延續 RC 版本系列的快速迭代。功能集包含 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、CodeBuddy 和 Qoder 編碼代理整合、完整 Codex 支持、embeddings 和 FTS 自癒機制、Windows FTS 診斷、Napi SIGABRT 修復、符號索引 0-based/1-based 行號映射。快取/CLI/嵌入管道系列增強 HTTP 可恢復性、批量插入重試安全、文本承載節點回退、樹 sitter NUL 位元組恢復。本版本與前一版本功能集保持一致。RC 預發佈版本供早期測試驗證。"
key_points:
  - "MCP 確定性政策系列完整落地：失敗封閉只讀模式、倉庫白名單強制、遠端綁定 Bearer 認證、確定性回應預算"
  - "多層次自癒機制：embeddings 安裝恢復、FTS 擴展自癒、嵌入管道復原"
  - "Windows 平台加固：FTS 缺依賴診斷、Napi SIGABRT 修復、符號索引行號映射"
...
GitNexus v1.6.10-rc.43 於 2026 年 7 月 17 日 12:56 UTC 發佈，延續 RC 版本系列的快速迭代。功能集包含 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、CodeBuddy 和 Qoder 編碼代理整合、完整 Codex 支持、embeddings 和 FTS 自癒機制、Windows FTS 診斷、Napi SIGABRT 修復、符號索引 0-based/1-based 行號映射。快取/CLI/嵌入管道系列增強 HTTP 可恢復性、批量插入重試安全、文本承載節點回退、樹 sitter NUL 位元組恢復。本版本與前一版本功能集保持一致。RC 預發佈版本供早期測試驗證。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.43)
