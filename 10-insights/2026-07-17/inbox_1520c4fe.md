...
id: inbox_1520c4fe
date: 2026-07-17
source_ref: "[[00-inbox/.../inbox_1520c4fe]]"
title: "Release Candidate v1.6.10-rc.41"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.41
source: gitnexus-releases
published_at: 2026-07-17T04:48:29+00:00
fetched_at: 2026-07-18T01:43:24.338573+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.41 於 2026 年 7 月 17 日 04:48 UTC 發佈，是 v1.6.10 預發佈候選系列中第二個版本。本 RC 功能集與 rc.40 保持一致，聚焦 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、編碼代理整合（CodeBuddy、Qoder）、完整 Codex 支持（hooks、插件市場、安裝流程）、embeddings 和 FTS 自癒機制。Windows 平台穩定性加固包括 FTS 缺依賴診斷、Napi::Error SIGABRT 修復、符號索引 0-based/1-based 映射。快取/CLI/嵌入管道系列增強：HTTP 嵌入可恢復性、批量插入重試安全、解析檔案邊界控制、文本承載節點回退、樹 sitter NUL 位元組恢復。作為 RC 快速迭代版本供早期測試。"
key_points:
  - "MCP 確定性政策系列完整落地：失敗封閉只讀模式、倉庫白名單強制、遠端綁定 Bearer 認證、參數規範化及確定性回應預算"
  - "多層次自癒機制：embeddings 安裝恢復、FTS 擴展自癒、嵌入管道復原，降低部署失敗率"
...
## Release Candidate v1.6.10-rc.41

GitNexus v1.6.10-rc.41 於 2026 年 7 月 17 日 04:48 UTC 發佈，是 v1.6.10 預發佈候選系列中第二個版本。本 RC 功能集與 rc.40 保持一致，聚焦 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、編碼代理整合（CodeBuddy、Qoder）、完整 Codex 支持（hooks、插件市場、安裝流程）、embeddings 和 FTS 自癒機制。Windows 平台穩定性加固包括 FTS 缺依賴診斷、Napi::Error SIGABRT 修復、符號索引 0-based/1-based 映射。快取/CLI/嵌入管道系列增強：HTTP 嵌入可恢復性、批量插入重試安全、解析檔案邊界控制、文本承載節點回退、樹 sitter NUL 位元組恢復。作為 RC 快速迭代版本供早期測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.41)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.41 \n Target base: 1.6.10 (rc #41 )\n Source commit (main): 527ea5f \n Release commit (versioned tree): 4d0dba0 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.41
