...
id: inbox_a6c6ea9c
date: 2026-07-17
source_ref: "[[00-inbox/.../inbox_a6c6ea9c]]"
title: "Release Candidate v1.6.10-rc.40"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.40
source: gitnexus-releases
published_at: 2026-07-17T04:13:25+00:00
fetched_at: 2026-07-18T01:43:24.339423+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.40 於 2026 年 7 月 17 日發佈，聚焦四大核心領域：(1) 編碼代理與完整 Codex 支持——新增 CodeBuddy 和 Qoder 整合，全面實現 Codex（含 hooks、插件市場、安裝流程，取代 #1131）。(2) MCP 確定性與安全政策系列——失敗封閉只讀模式、倉庫白名單強制、遠端 Bearer 認證、impact/context 參數規範化、確定性回應預算，強化協議確定性。(3) 平台穩定性與自癒機制——embeddings 自癒、FTS 擴展自癒、Windows FTS 缺依賴診斷（第 1 階段）、符號索引 0-based/1-based 行號映射（MCP 顯示）、Napi::Error SIGABRT 修復、HTTP 嵌入端點錯誤報告。(4) 快取/CLI/嵌入管道系列——HTTP 嵌入可恢復性、批量插入重試安全、文本承載節點回退、樹 sitter NUL 位元組恢復。RC 版本供早期測試，穩定版保持 latest dist-tag。"
key_points:
  - "MCP 確定性政策系列完整落地：失敗封閉只讀模式、倉庫白名單強制、遠端綁定 Bearer 認證、參數規範化及確定性回應預算，強化協議安全性"
  - "多層次自癒機制：embeddings 安裝恢復、FTS 擴展自癒、嵌入管道復原，降低部署失敗率和人工介入成本"
  - "Windows 平台加固重點：FTS 缺依賴診斷、Napi SIGABRT 修復（C++ 類型索引和工作者安全終止點）、符號索引 0-based/1-based 映射支撐跨平台 CI"
tags: [gitnexus, codex-support, coding-agents, mcp-policy, determinism, self-heal, windows-stability, embeddings]
topics: [agents.mcp]
importance: 4
novelty: 4
insight_quality: 3
...
## Release Candidate v1.6.10-rc.40

GitNexus v1.6.10-rc.40 於 2026 年 7 月 17 日發佈，聚焦四大核心領域：(1) 編碼代理與完整 Codex 支持——新增 CodeBuddy 和 Qoder 整合，全面實現 Codex（含 hooks、插件市場、安裝流程，取代 #1131）。(2) MCP 確定性與安全政策系列——失敗封閉只讀模式、倉庫白名單強制、遠端 Bearer 認證、impact/context 參數規範化、確定性回應預算，強化協議確定性。(3) 平台穩定性與自癒機制——embeddings 自癒、FTS 擴展自癒、Windows FTS 缺依賴診斷（第 1 階段）、符號索引 0-based/1-based 行號映射（MCP 顯示）、Napi::Error SIGABRT 修復、HTTP 嵌入端點錯誤報告。(4) 快取/CLI/嵌入管道系列——HTTP 嵌入可恢復性、批量插入重試安全、文本承載節點回退、樹 sitter NUL 位元組恢復。RC 版本供早期測試，穩定版保持 latest dist-tag。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.40)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.40 \n Target base: 1.6.10 (rc #40 )\n Source commit (main): e8fdc2e \n Release commit (versioned tree): 9cf8692 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.40
