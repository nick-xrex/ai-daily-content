...
id: inbox_e59abfea
date: 2026-07-17
source_ref: "[[00-inbox/.../inbox_e59abfea]]"
title: "Release Candidate v1.6.10-rc.42"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.42
source: gitnexus-releases
published_at: 2026-07-17T11:58:05+00:00
fetched_at: 2026-07-18T01:43:24.337845+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.42 於 2026 年 7 月 17 日 11:58 UTC 發佈，是 RC 版本系列的第三個迭代。功能集與前一版本相同，包含 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、CodeBuddy 和 Qoder 編碼代理整合、完整 Codex 支持（hooks、插件市場、安裝流程）、embeddings 和 FTS 自癒、Windows FTS 診斷、Napi SIGABRT 修復、符號索引行號映射。快取/CLI/嵌入管道系列：HTTP 可恢復性、批量插入重試安全、文本承載回退、樹 sitter 恢復。新貢獻者 @vlisitskii、@100yenadmin、@bong-water-water-bong 首次參與。RC 供早期測試使用。"
key_points:
  - "MCP 確定性政策系列完整落地：失敗封閉只讀模式、倉庫白名單強制、遠端綁定 Bearer 認證、確定性回應預算"
  - "多層次自癒機制：embeddings 安裝恢復、FTS 擴展自癒、嵌入管道復原"
  - "Windows 平台加固：FTS 缺依賴診斷、Napi SIGABRT 修復、符號索引 0-based/1-based 映射"
tags: [gitnexus, codex-support, coding-agents, mcp-policy, determinism, self-heal, windows-stability]
topics: [agents.mcp]
importance: 4
novelty: 1
insight_quality: 3
...
## Release Candidate v1.6.10-rc.42

GitNexus v1.6.10-rc.42 於 2026 年 7 月 17 日 11:58 UTC 發佈，是 RC 版本系列的第三個迭代。功能集與前一版本相同，包含 MCP 確定性政策系列（失敗封閉只讀、倉庫白名單、遠端 Bearer 認證、確定性預算）、CodeBuddy 和 Qoder 編碼代理整合、完整 Codex 支持（hooks、插件市場、安裝流程）、embeddings 和 FTS 自癒、Windows FTS 診斷、Napi SIGABRT 修復、符號索引行號映射。快取/CLI/嵌入管道系列：HTTP 可恢復性、批量插入重試安全、文本承載回退、樹 sitter 恢復。新貢獻者 @vlisitskii、@100yenadmin、@bong-water-water-bong 首次參與。RC 供早期測試使用。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.42)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.42 \n Target base: 1.6.10 (rc #42 )\n Source commit (main): dc993a6 \n Release commit (versioned tree): 6f84f73 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.42
