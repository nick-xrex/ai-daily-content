...
id: inbox_da89e144
date: 2026-08-09
source_ref: "[[00-inbox/2026-08-09/2203-gitnexus-releases-release-candidate-v1-6-10-rc-183-7999]]"
title: "Release Candidate v1.6.10-rc.183"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.183
source: gitnexus-releases
published_at: 2026-08-09T11:46:48+00:00
fetched_at: 2026-08-10T04:27:24.102183+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 釋出 v1.6.10-rc.183，包含重要的安全、功能與效能改進。安全面向改善 MCP 啟動相容性並優化 CLI 命令延遲載入；功能方面新增 Docker 原生支援、HTTP 自託管遠端嵌入後端、Swift 完整支援、git commit 後自動重新索引（保留嵌入）、新增 CLI index 命令登記現有 .gitnexus/ 資料夾；效能最佳化消除 Go 語言 O(n²) 作用域捕獲走訪；錯誤修復涵蓋全域安裝清理、快取目錄設定、大型儲存庫解析快取分片、MCP 平行工具呼叫防護；語言支援已覆蓋 PHP 8+ Laravel、Ruby、Kotlin、Swift iOS、C/C++/C#/Rust 等，完成第 8 階段型別解析（欄位/屬性型別）。"
key_points:
  - "Docker 原生支援、HTTP 自託管嵌入後端、git commit 勾點自動重新索引"
  - "Go 語言 O(n²) 作用域捕獲消除（#1915）；大型儲存庫測試呼叫邊 294,416 → 301,443 (+7,027)"
  - "完成 8 階段型別解析：可為 null 解析、迴圈型別推論、模式比對、容器描述符、10+ 語言覆蓋"
tags: [mcp-compatibility, docker-support, http-embeddings, type-resolution-phase-8, go-performance]
topics: []
importance: 4
novelty: 2
insight_quality: 3
...
## Release Candidate v1.6.10-rc.183

GitNexus 釋出 v1.6.10-rc.183，包含重要的安全、功能與效能改進。安全面向改善 MCP 啟動相容性並優化 CLI 命令延遲載入；功能方面新增 Docker 原生支援、HTTP 自託管遠端嵌入後端、Swift 完整支援、git commit 後自動重新索引（保留嵌入）、新增 CLI index 命令登記現有 .gitnexus/ 資料夾；效能最佳化消除 Go 語言 O(n²) 作用域捕獲走訪；錯誤修復涵蓋全域安裝清理、快取目錄設定、大型儲存庫解析快取分片、MCP 平行工具呼叫防護；語言支援已覆蓋 PHP 8+ Laravel、Ruby、Kotlin、Swift iOS、C/C++/C#/Rust 等，完成第 8 階段型別解析（欄位/屬性型別）。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.183)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.183 \n Target base: 1.6.10 (rc #183)\n Source commit (main): 81100e2 \n Release commit (versioned tree): 9733963 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
