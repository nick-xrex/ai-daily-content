...
id: inbox_01155c6d
date: 2026-06-04
source_ref: "[[00-inbox/2026-06-04/0040-gitnexus-releases-release-candidate-v1-6-6-rc-137-797d]]"
title: "Release Candidate v1.6.6-rc.137"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.137
source: gitnexus-releases
published_at: 2026-06-04T12:10:15+00:00
fetched_at: 2026-06-05T00:46:13.608357+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.137 預發行版本於 6 月 4 日上午發布。本版本特性：Git commit 觸發自動重新索引、HTTP 遠端內嵌後端、Swift 完全支援、Docker 容器化支援、多語言 AST 智能含 8 階段類型推論覆蓋 10+ 程式語言。基礎設施遷移：KuzuDB 至 LadybugDB v0.15。安全性改進 MCP 啟動相容性與 CLI 延遲載入；bug 修復包括 npm 全域升級 ENOTEMPTY 錯誤、快取目錄權限問題、樹狀解析器 proto 套件、大型儲存庫快取分片。性能改進消除 Go 作用域擷取 O(n²) 重走問題，並修強 CI/CD 工作流。"
key_points:
  - "Auto-reindex on git commit with embeddings preservation；HTTP embedding backend for self-hosted remote endpoints"
  - "Multi-language AST intelligence with 8-phase type resolution covering Swift/Ruby/Kotlin/PHP/Python/JavaScript/etc"
  - "Database migration from KuzuDB to LadybugDB v0.15；O(n²) scope-capture re-walk elimination；npm global upgrade fixes"
tags: [gitnexus, code-analysis, embeddings, type-resolution, ast-parsing]
topics: []
importance: 2
novelty: 2
insight_quality: 3
...
## Release Candidate v1.6.6-rc.137

GitNexus v1.6.6-rc.137 預發行版本於 6 月 4 日上午發布。本版本特性：Git commit 觸發自動重新索引、HTTP 遠端內嵌後端、Swift 完全支援、Docker 容器化支援、多語言 AST 智能含 8 階段類型推論覆蓋 10+ 程式語言。基礎設施遷移：KuzuDB 至 LadybugDB v0.15。安全性改進 MCP 啟動相容性與 CLI 延遲載入；bug 修復包括 npm 全域升級 ENOTEMPTY 錯誤、快取目錄權限問題、樹狀解析器 proto 套件、大型儲存庫快取分片。性能改進消除 Go 作用域擷取 O(n²) 重走問題，並修強 CI/CD 工作流。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.137)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.137 \n Target base: 1.6.6 (rc #137 )\n Source commit (main): 938111a \n Release commit (versioned tree): b5beeda \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 chore: upgrade tree-sitter to 0.25.0 by 
