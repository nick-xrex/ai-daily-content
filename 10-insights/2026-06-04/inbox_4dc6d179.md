...
id: inbox_4dc6d179
date: 2026-06-04
source_ref: "[[00-inbox/2026-06-04/0040-gitnexus-releases-release-candidate-v1-6-6-rc-140-bc7e]]"
title: "Release Candidate v1.6.6-rc.140"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.140
source: gitnexus-releases
published_at: 2026-06-04T17:28:53+00:00
fetched_at: 2026-06-05T00:46:13.589208+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.140 預發行版本於同日稍後釋出。繼續推進代碼智能功能：Git commit 後自動重新索引並保留內嵌、HTTP 遠端內嵌後端、完整 Swift 支援（含 constructor resolution、export detection、implicit imports）、新增 CLI index 命令註冊現有資料夾、Docker 原生支援。資料庫層遷移 KuzuDB 至 LadybugDB v0.15；實現 8 階段類型推論覆蓋 10+ 程式語言。Bug 修復涵蓋 npm 全域升級、樹狀解析器 proto 生命週期、parse cache sharding、Go O(n²) 瓶頸消除。"
key_points:
  - "HTTP embedding backend 用於自架遠端端點；auto-reindex 保留內嵌向量用於代碼智能"
  - "Complete Swift language support with constructor resolution & implicit imports；multi-language type resolution phase 4-8"
  - "LadybugDB v0.15 遷移；npm preinstall cleanup、樹狀解析器 proto devendor、Go scope-capture O(n²) 刪除"
tags: [gitnexus, code-intelligence, language-support, embeddings, type-system]
topics: []
importance: 2
novelty: 2
insight_quality: 3
...
## Release Candidate v1.6.6-rc.140

GitNexus v1.6.6-rc.140 預發行版本於同日稍後釋出。繼續推進代碼智能功能：Git commit 後自動重新索引並保留內嵌、HTTP 遠端內嵌後端、完整 Swift 支援（含 constructor resolution、export detection、implicit imports）、新增 CLI index 命令註冊現有資料夾、Docker 原生支援。資料庫層遷移 KuzuDB 至 LadybugDB v0.15；實現 8 階段類型推論覆蓋 10+ 程式語言。Bug 修復涵蓋 npm 全域升級、樹狀解析器 proto 生命週期、parse cache sharding、Go O(n²) 瓶頸消除。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.140)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.140 \n Target base: 1.6.6 (rc #140 )\n Source commit (main): bd59fa9 \n Release commit (versioned tree): ce3b912 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
