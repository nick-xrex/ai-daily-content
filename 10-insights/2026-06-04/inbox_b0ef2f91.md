...
id: inbox_b0ef2f91
date: 2026-06-04
source_ref: "[[00-inbox/2026-06-04/0040-gitnexus-releases-release-candidate-v1-6-6-rc-134-9b6a]]"
title: "Release Candidate v1.6.6-rc.134"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.134
source: gitnexus-releases
published_at: 2026-06-04T10:31:36+00:00
fetched_at: 2026-06-05T00:48:01.617971+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 發布 RC 版本 1.6.6-rc.134，延續多語言代碼分析路線。核心改進包括 MCP 啟動兼容性增強、git 提交後自動重新索引（保留嵌入向量）、HTTP 嵌入後端支持自主部署。新增完整 Swift 語言支持（查詢修正、隱式導入、構造器解析），CLI 新增 index 命令用於註冊已有資料夾，並加入 Docker 支持簡化部署流程。Bug 修復涵蓋全局升級 ENOTEMPTY 錯誤、快取權限問題、Go 中 O(n²) scope-capture 性能退化。CI/CD 擴展至 macOS 完成交叉平台測試。"
key_points:
...
## Release Candidate v1.6.6-rc.134

GitNexus 發布 RC 版本 1.6.6-rc.134，延續多語言代碼分析路線。核心改進包括 MCP 啟動兼容性增強、git 提交後自動重新索引（保留嵌入向量）、HTTP 嵌入後端支持自主部署。新增完整 Swift 語言支持（查詢修正、隱式導入、構造器解析），CLI 新增 index 命令用於註冊已有資料夾，並加入 Docker 支持簡化部署流程。Bug 修復涵蓋全局升級 ENOTEMPTY 錯誤、快取權限問題、Go 中 O(n²) scope-capture 性能退化。CI/CD 擴展至 macOS 完成交叉平台測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.134)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.134 \n Target base: 1.6.6 (rc #134 )\n Source commit (main): 083aedb \n Release commit (versioned tree): cba0608 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
