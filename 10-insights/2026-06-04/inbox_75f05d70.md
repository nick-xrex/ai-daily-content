...
id: inbox_75f05d70
date: 2026-06-04
source_ref: "[[00-inbox/2026-06-04/0040-gitnexus-releases-release-candidate-v1-6-6-rc-138-c08c]]"
title: "Release Candidate v1.6.6-rc.138"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.138
source: gitnexus-releases
published_at: 2026-06-04T12:44:14+00:00
fetched_at: 2026-06-05T00:46:13.602106+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.138 預發行版本同日中午發布。本版本包含 Git commit 後自動重新索引與內嵌保留、HTTP 遠端內嵌後端支援自架部署、完整 Swift 語言支援、Docker 容器化、LadybugDB v0.15 資料庫遷移、8 階段多語言類型推論系統。修復內容：npm 全域升級時 ENOTEMPTY 錯誤、快取目錄可寫權限設定、樹狀解析器 proto 生命週期、大型儲存庫快取分片持久化。性能優化關鍵成就為消除 Go 作用域擷取 O(n²) 重複遍歷（解決 issue #1848），安全性強化 MCP 啟動相容性。"
key_points:
  - "Auto-reindex with embeddings preservation；HTTP embedding backend 用於自架端點"
  - "Complete Swift support：query fix, export detection, implicit imports, constructor resolution；type resolution phases 4-8"
  - "LadybugDB v0.15 migration；O(n²) scope-capture re-walk 消除；npm global upgrade reliability fixes"
tags: [gitnexus, code-intelligence, embeddings, ast-analysis, database-migration]
topics: []
importance: 2
novelty: 2
insight_quality: 3
...
## Release Candidate v1.6.6-rc.138

GitNexus v1.6.6-rc.138 預發行版本同日中午發布。本版本包含 Git commit 後自動重新索引與內嵌保留、HTTP 遠端內嵌後端支援自架部署、完整 Swift 語言支援、Docker 容器化、LadybugDB v0.15 資料庫遷移、8 階段多語言類型推論系統。修復內容：npm 全域升級時 ENOTEMPTY 錯誤、快取目錄可寫權限設定、樹狀解析器 proto 生命週期、大型儲存庫快取分片持久化。性能優化關鍵成就為消除 Go 作用域擷取 O(n²) 重複遍歷（解決 issue #1848），安全性強化 MCP 啟動相容性。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.138)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.138 \n Target base: 1.6.6 (rc #138 )\n Source commit (main): 7cbc544 \n Release commit (versioned tree): fe808da \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
