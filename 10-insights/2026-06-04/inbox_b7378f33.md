...
id: inbox_b7378f33
date: 2026-06-04
source_ref: "[[00-inbox/2026-06-04/0040-gitnexus-releases-release-candidate-v1-6-6-rc-136-2b37]]"
title: "Release Candidate v1.6.6-rc.136"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.136
source: gitnexus-releases
published_at: 2026-06-04T11:37:13+00:00
fetched_at: 2026-06-05T00:48:01.610713+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus 發布 RC 版本 1.6.6-rc.136，延續多語言代碼分析路線。核心改進包括 MCP 啟動兼容性增強、git 提交後自動重新索引（保留嵌入向量）、HTTP 嵌入後端支持自主部署。新增完整 Swift 語言支持（查詢修正、隱式導入、構造器解析），CLI 新增 index 命令用於註冊已有資料夾，並加入 Docker 支持簡化部署流程。Bug 修復涵蓋全局升級 ENOTEMPTY 錯誤、快取權限問題、Go 中 O(n²) scope-capture 性能退化。CI/CD 擴展至 macOS 完成交叉平台測試。"
key_points:
  - "Auto-reindex with embeddings preservation — git 提交後自動重新索引且保持嵌入向量完整性"
  - "HTTP embedding backend — 支持自主部署的遠程嵌入服務"
  - "Go scope-capture O(n²) → linear — 解決大倉庫性能退化問題"
tags: [gitnexus, code-analysis, embeddings, swift-support, docker]
topics: []
importance: 3
novelty: 3
insight_quality: 2
...
## Release Candidate v1.6.6-rc.136

GitNexus 發布 RC 版本 1.6.6-rc.136，延續多語言代碼分析路線。核心改進包括 MCP 啟動兼容性增強、git 提交後自動重新索引（保留嵌入向量）、HTTP 嵌入後端支持自主部署。新增完整 Swift 語言支持（查詢修正、隱式導入、構造器解析），CLI 新增 index 命令用於註冊已有資料夾，並加入 Docker 支持簡化部署流程。Bug 修復涵蓋全局升級 ENOTEMPTY 錯誤、快取權限問題、Go 中 O(n²) scope-capture 性能退化。CI/CD 擴展至 macOS 完成交叉平台測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.136)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.136 \n Target base: 1.6.6 (rc #136 )\n Source commit (main): 2aa78a6 \n Release commit (versioned tree): 569c494 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
