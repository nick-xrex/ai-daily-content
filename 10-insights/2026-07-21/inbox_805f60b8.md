...
id: inbox_805f60b8
date: 2026-07-21
source_ref: "[[00-inbox/2026-07-21/0016-simon-willison-a-fireside-chat-with-cat-and-thariq-from-239c]]"
...
fetched_at: 2026-07-22T00:22:53.687519+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "Anthropic Claude Code 團隊在 AI Engineer World's Fair 座談會中分享編碼代理工作流程的演進。Claude Tag（新 Slack 協作工具）已在內部落地 65% 的產品工程 PR，具備多人協作、主動監控、團隊記憶功能。重大發現：現代模型（Fable 5、Opus 4.8）不再受益於 system prompt 中的範例，Claude Code 已將 prompt 大小縮減 80%；避免「禁止做 X」型指令列表。團隊採用「Ant Fooding」策略先在員工驗證留存。Auto Mode 被視為協作技術基石。Thariq 強調代碼重寫若配合完整測試套件已成可行策略。"
key_points:
  - "Claude Tag 落地 65% 產品工程 PR，特色為多人協作、主動 bug 監控、團隊記憶（記住協作偏好）"
  - "Modern models 最佳實踐已轉變：移除 system prompt 中的範例（prompt 減 80%），避免負面指令列表"
  - "代碼重寫策略現已可行，需配合完整測試套件；codebase 本身可作為規格文件"
tags: [claude-code, claude-tag, prompt-engineering, system-prompts, auto-mode]
...
Anthropic Claude Code 團隊在 AI Engineer World's Fair 座談會中分享編碼代理工作流程的演進。Claude Tag（新 Slack 協作工具）已在內部落地 65% 的產品工程 PR，具備多人協作、主動監控、團隊記憶功能。重大發現：現代模型（Fable 5、Opus 4.8）不再受益於 system prompt 中的範例，Claude Code 已將 prompt 大小縮減 80%；避免「禁止做 X」型指令列表。團隊採用「Ant Fooding」策略先在員工驗證留存。Auto Mode 被視為協作技術基石。Thariq 強調代碼重寫若配合完整測試套件已成可行策略。
...
**原文：** [simon-willison](https://simonwillison.net/2026/Jul/21/cat-and-thariq/#atom-everything)
