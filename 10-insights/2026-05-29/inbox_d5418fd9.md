...
id: inbox_d5418fd9
date: 2026-05-29
source_ref: "[[00-inbox/2026-05-29/0216-gitnexus-releases-release-candidate-v1-6-6-rc-85-92e3]]"
title: "Release Candidate v1.6.6-rc.85"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.85
source: gitnexus-releases
published_at: 2026-05-29T07:17:08+00:00
fetched_at: 2026-05-30T02:22:07.197264+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.85 發布。新增 HTTP embedding 後端（自託管/遠程）、完整 Swift 語言支持（查詢修復、導入檢測、構造函數解析）、Docker 容器化、CLI 'index' 命令。MCP 啟動兼容性改進、git 提交自動重新索引、parse cache 分片支持大型倉庫。多項 bug fixes 針對升級清理、緩存目錄權限設置、樹 sitter proto devendor。"
key_points:
  - "HTTP embedding 後端支持自託管和遠程端點，提升部署靈活性"
  - "完整 Swift 語言支持包括 SPM 導入解析和 iOS 專用功能"
  - "Docker 支持和自動重新索引保留 embeddings，改善開發體驗"
tags: [gitnexus, code-analysis, embeddings, swift]
topics: [agents.mcp]
importance: 3
novelty: 4
insight_quality: 3
...
## Release Candidate v1.6.6-rc.85

GitNexus v1.6.6-rc.85 發布。新增 HTTP embedding 後端（自託管/遠程）、完整 Swift 語言支持（查詢修復、導入檢測、構造函數解析）、Docker 容器化、CLI 'index' 命令。MCP 啟動兼容性改進、git 提交自動重新索引、parse cache 分片支持大型倉庫。多項 bug fixes 針對升級清理、緩存目錄權限設置、樹 sitter proto devendor。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.85)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.85 \n Target base: 1.6.6 (rc #85 )\n Source commit (main): 7dae4fc \n Release commit (versioned tree): b0e3f13 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
