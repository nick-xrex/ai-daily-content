...
id: inbox_6e6d6764
date: 2026-05-29
source_ref: "[[00-inbox/2026-05-29/0216-gitnexus-releases-release-candidate-v1-6-6-rc-84-5473]]"
title: "Release Candidate v1.6.6-rc.84"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.84
source: gitnexus-releases
published_at: 2026-05-29T06:18:30+00:00
fetched_at: 2026-05-30T02:22:07.197602+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.84 發布。新增 HTTP embedding 後端（自託管/遠程）、完整 Swift 支持、Docker 容器化、'index' CLI 命令。MCP 兼容性改進、git 提交自動重新索引保留 embeddings、parse cache 分片優化大型倉庫。Bug fixes 包括升級清理防止 ENOTEMPTY、緩存目錄權限、樹 sitter proto devendor。"
key_points:
  - "HTTP embedding 後端移除遠程依賴，支持自託管部署"
  - "完整 Swift 語言支持覆蓋 iOS 和 SPM 生態"
  - "自動重新索引保留 embeddings，提升增量更新效率"
tags: [gitnexus, embeddings, swift, mcp-compat]
topics: [agents.mcp]
importance: 3
novelty: 4
insight_quality: 3
...
## Release Candidate v1.6.6-rc.84

GitNexus v1.6.6-rc.84 發布。新增 HTTP embedding 後端（自託管/遠程）、完整 Swift 支持、Docker 容器化、'index' CLI 命令。MCP 兼容性改進、git 提交自動重新索引保留 embeddings、parse cache 分片優化大型倉庫。Bug fixes 包括升級清理防止 ENOTEMPTY、緩存目錄權限、樹 sitter proto devendor。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.84)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.84 \n Target base: 1.6.6 (rc #84 )\n Source commit (main): d71fd16 \n Release commit (versioned tree): 343d232 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
