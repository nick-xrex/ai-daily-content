...
id: inbox_329b3d6f
date: 2026-05-29
source_ref: "[[00-inbox/2026-05-29/0216-gitnexus-releases-release-candidate-v1-6-6-rc-86-8b71]]"
title: "Release Candidate v1.6.6-rc.86"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.86
source: gitnexus-releases
published_at: 2026-05-29T08:50:04+00:00
fetched_at: 2026-05-30T02:22:07.196587+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.86 發布。核心功能包括 HTTP embedding 後端（自託管/遠程）、完整 Swift 語言支持、Docker 支持、'index' CLI 命令註冊現有倉庫。MCP 啟動兼容性改進、git 提交後自動重新索引保留 embeddings、parse cache 分片優化大型倉庫。修復升級清理問題、緩存目錄權限、樹 sitter proto devendor。"
key_points:
  - "HTTP embedding 後端移除雲端依賴，支持自託管和遠程部署"
  - "完整 Swift 語言支持覆蓋 iOS 和 SPM 生態"
  - "自動重新索引保留 embeddings，改善增量更新效率和性能"
tags: [gitnexus, embeddings, swift, mcp]
topics: [agents.mcp]
importance: 3
novelty: 4
insight_quality: 3
...
## Release Candidate v1.6.6-rc.86

GitNexus v1.6.6-rc.86 發布。核心功能包括 HTTP embedding 後端（自託管/遠程）、完整 Swift 語言支持、Docker 支持、'index' CLI 命令註冊現有倉庫。MCP 啟動兼容性改進、git 提交後自動重新索引保留 embeddings、parse cache 分片優化大型倉庫。修復升級清理問題、緩存目錄權限、樹 sitter proto devendor。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.86)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.86 \n Target base: 1.6.6 (rc #86 )\n Source commit (main): 2f15c1e \n Release commit (versioned tree): ac53848 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
