...
id: inbox_085cea06
date: 2026-05-29
source_ref: "[[00-inbox/2026-05-29/0216-gitnexus-releases-release-candidate-v1-6-6-rc-87-77e2]]"
title: "Release Candidate v1.6.6-rc.87"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.87
source: gitnexus-releases
published_at: 2026-05-29T14:02:51+00:00
fetched_at: 2026-05-30T02:22:07.194309+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.87 發布。新增 HTTP embedding 後端支持自託管和遠程端點、完整 Swift 語言支持（查詢修復、導入解析、構造函數解析）、Docker 容器化、CLI 'index' 命令用於註冊現有 .gitnexus 文件夾。MCP 啟動兼容性改進、git 提交後自動重新索引並保留 embeddings、parse cache 分片以支持大型倉庫。多項 bug fixes 包括升級清理防止 ENOTEMPTY 錯誤、緩存目錄權限設置、樹 sitter proto devendor。"
key_points:
  - "HTTP embedding 後端支持自託管和遠程端點，擴展部署靈活性至企業環境"
  - "完整 Swift 語言支持，包括 SPM 導入解析和 iOS 構造函數解析"
  - "自動重新索引保留 embeddings、Docker 支持、parse cache 分片優化大型倉庫性能"
tags: [gitnexus, code-analysis, embeddings, mcp, docker]
topics: [agents.mcp]
importance: 3
novelty: 4
insight_quality: 3
...
## Release Candidate v1.6.6-rc.87

GitNexus v1.6.6-rc.87 發布。新增 HTTP embedding 後端支持自託管和遠程端點、完整 Swift 語言支持（查詢修復、導入解析、構造函數解析）、Docker 容器化、CLI 'index' 命令用於註冊現有 .gitnexus 文件夾。MCP 啟動兼容性改進、git 提交後自動重新索引並保留 embeddings、parse cache 分片以支持大型倉庫。多項 bug fixes 包括升級清理防止 ENOTEMPTY 錯誤、緩存目錄權限設置、樹 sitter proto devendor。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.87)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.87 \n Target base: 1.6.6 (rc #87 )\n Source commit (main): 23bf594 \n Release commit (versioned tree): d6e55b0 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
