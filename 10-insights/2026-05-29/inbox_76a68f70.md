...
id: inbox_76a68f70
date: 2026-05-29
source_ref: "[[00-inbox/2026-05-29/0216-gitnexus-releases-release-candidate-v1-6-6-rc-83-7228]]"
title: "Release Candidate v1.6.6-rc.83"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.83
source: gitnexus-releases
published_at: 2026-05-29T05:27:45+00:00
fetched_at: 2026-05-30T02:22:07.197869+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.83 發布。核心新增：HTTP embedding 後端支持自託管和遠程端點、完整 Swift 語言支持（查詢修復、導入檢測、構造函數解析）、Docker 容器化、CLI 'index' 命令。MCP 啟動兼容性改進、git 提交自動重新索引保留 embeddings、parse cache 分片支持大型倉庫。多個 bug fixes 針對升級、緩存目錄權限、樹 sitter devendor。"
key_points:
  - "HTTP embedding 後端提升部署靈活性，支持企業自託管環境"
  - "完整 Swift 語言支持包括 SPM 導入解析和 iOS 專用功能"
  - "自動重新索引和 parse cache 分片優化大型倉庫增量更新性能"
tags: [gitnexus, code-intelligence, embeddings, swift]
topics: [agents.mcp]
importance: 3
novelty: 4
insight_quality: 3
...
## Release Candidate v1.6.6-rc.83

GitNexus v1.6.6-rc.83 發布。核心新增：HTTP embedding 後端支持自託管和遠程端點、完整 Swift 語言支持（查詢修復、導入檢測、構造函數解析）、Docker 容器化、CLI 'index' 命令。MCP 啟動兼容性改進、git 提交自動重新索引保留 embeddings、parse cache 分片支持大型倉庫。多個 bug fixes 針對升級、緩存目錄權限、樹 sitter devendor。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.83)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.83 \n Target base: 1.6.6 (rc #83 )\n Source commit (main): 7b38b8a \n Release commit (versioned tree): 3062c5b \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
