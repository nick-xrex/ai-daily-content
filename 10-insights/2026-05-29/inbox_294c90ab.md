...
id: inbox_294c90ab
date: 2026-05-29
source_ref: "[[00-inbox/2026-05-29/0216-gitnexus-releases-release-candidate-v1-6-6-rc-89-a0fe]]"
title: "Release Candidate v1.6.6-rc.89"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.89
source: gitnexus-releases
published_at: 2026-05-29T17:46:45+00:00
fetched_at: 2026-05-30T02:21:08.279698+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.89 發佈，強化 MCP 啟動相容性與懶加載 CLI 命令。新增特性包括：git commit 後自動重索引同時保留嵌入向量、HTTP embedding 後端支持自託管及遠端端點部署、Swift 語言完整支持（含 SPM 導入解析）、Docker 容器化支持。修復關鍵問題：npm 全局升級的 ENOTEMPTY 錯誤、cache 目錄用戶可寫位置設定、大型倉庫 parse cache 分片策略。此版本為 RC 面向早期測試。"
key_points:
...
## Release Candidate v1.6.6-rc.89

GitNexus v1.6.6-rc.89 發佈，強化 MCP 啟動相容性與懶加載 CLI 命令。新增特性包括：git commit 後自動重索引同時保留嵌入向量、HTTP embedding 後端支持自託管及遠端端點部署、Swift 語言完整支持（含 SPM 導入解析）、Docker 容器化支持。修復關鍵問題：npm 全局升級的 ENOTEMPTY 錯誤、cache 目錄用戶可寫位置設定、大型倉庫 parse cache 分片策略。此版本為 RC 面向早期測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.89)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.89 \n Target base: 1.6.6 (rc #89 )\n Source commit (main): 85727ca \n Release commit (versioned tree): bccbc8d \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
