...
id: inbox_491deb35
date: 2026-08-07
source_ref: "[[00-inbox/.../inbox_491deb35]]"
title: "Release Candidate v1.6.10-rc.175"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.175
source: gitnexus-releases
published_at: 2026-08-07T16:33:13+00:00
fetched_at: 2026-08-11T01:17:00.886614+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.175 為連續自動化發佈候選版本，功能集與 rc.174 完全相同，包含 O(n²) → O(n) Go 解析器優化、HTTP 嵌入式後端、完整 Swift 支援、Docker 容器化、自動索引保留嵌入資料。修復 npm 全域升級、快取持久化分片、MCP 伺服器並列工具呼叫穩定性。資料庫遷移 KuzuDB → LadybugDB v0.15。連續發佈指示發佈管線自動化與多層驗證流程成熟度。"
key_points:
  - "rc.175 為自動化發佈管線版本，內容與 rc.174 相同，指示發佈驗證管線多層次成熟化"
  - "Go 解析器 O(n²) scope-capture 消除顯著提升大儲存庫效能；HTTP 嵌入後端啟用自託管部署架構"
  - "KuzuDB→LadybugDB 資料庫遷移完成 + Docker 整合 + MCP 並列工具呼叫穩定性修復"
tags: [performance-optimization, go-parser, embeddings-backend, docker-support, release-candidate]
topics: [agents.mcp]
importance: 4
novelty: 3
insight_quality: 3
...
## Release Candidate v1.6.10-rc.175

GitNexus v1.6.10-rc.175 為連續自動化發佈候選版本，功能集與 rc.174 完全相同，包含 O(n²) → O(n) Go 解析器優化、HTTP 嵌入式後端、完整 Swift 支援、Docker 容器化、自動索引保留嵌入資料。修復 npm 全域升級、快取持久化分片、MCP 伺服器並列工具呼叫穩定性。資料庫遷移 KuzuDB → LadybugDB v0.15。連續發佈指示發佈管線自動化與多層驗證流程成熟度。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.175)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.175 \n Target base: 1.6.10 (rc #175 )\n Source commit (main): 997fc05 \n Release commit (versioned tree): 9859b90 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
