...
id: inbox_7cdb7c09
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-99-f24e]]"
title: "Release Candidate v1.6.6-rc.99"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.99
source: gitnexus-releases
published_at: 2026-05-30T12:28:00+00:00
fetched_at: 2026-05-31T00:43:31.726980+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.99 發佈（源 commit f5915ca）。MCP 啟動相容性改進與 lazy-load CLI；git commit 自動重新索引保留 embeddings；HTTP 遠端 embedding 後端支援自託管端點；完整 Swift 語言支援（查詢修正、匯出檢測、constructor 解析）；Docker 支援。Bug 修正包括全域升級 ENOTEMPTY 防護、cache directory user-writable、parse cache sharding 大型 repo 效能。macOS 測試矩陣加入 CI。"
key_points:
  - "MCP 相容性增強 + lazy-load CLI；KuzuDB 整合測試（#207, #209）"
  - "Git commit 自動重新索引保留 embeddings；HTTP embedding 後端支援遠端自託管（#205, #395）"
  - "Swift 查詢/匯出/constructor 完整支援、Docker、ENOTEMPTY/cache/cache sharding 修正、macOS 測試矩陣（#408, #848, #843-846, #1580, #208）"
tags: [gitnexus-release, release-candidate]
topics: []
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.99

GitNexus v1.6.6-rc.99 發佈（源 commit f5915ca）。MCP 啟動相容性改進與 lazy-load CLI；git commit 自動重新索引保留 embeddings；HTTP 遠端 embedding 後端支援自託管端點；完整 Swift 語言支援（查詢修正、匯出檢測、constructor 解析）；Docker 支援。Bug 修正包括全域升級 ENOTEMPTY 防護、cache directory user-writable、parse cache sharding 大型 repo 效能。macOS 測試矩陣加入 CI。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.99)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.99 \n Target base: 1.6.6 (rc #99 )\n Source commit (main): f5915ca \n Release commit (versioned tree): a2126d0 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 chore: upgrade tree-sitter to 0.25.0 by @m
