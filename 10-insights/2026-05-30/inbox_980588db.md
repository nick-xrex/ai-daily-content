...
id: inbox_980588db
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-95-a6a2]]"
title: "Release Candidate v1.6.6-rc.95"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.95
source: gitnexus-releases
published_at: 2026-05-30T09:03:48+00:00
fetched_at: 2026-05-31T00:45:17.061710+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.95 是自動化候選版本構建，包含五大功能改進：MCP 啟動兼容性增強與 CLI 指令懶加載、git 提交後自動重新索引且嵌入不丟失、HTTP 嵌入後端支持遠程與自託管部署、完整 Swift/iOS 支持（含 SPM 導入解析、隱式導入、構造函數判別）、Docker 容器化支持。並修復全局升級 ENOTEMPTY 錯誤、快取目錄權限問題、大倉庫解析快取分片。RC 系列用於 1.6.6 穩定版發布前的測試積累。"
key_points:
  - "MCP 啟動兼容性改進+CLI 懶加載，提升 Claude Code 集成穩定性"
  - "HTTP 嵌入後端支持遠程/自託管，擴展私有部署選項"
  - "完整 Swift+Docker 支持，涵蓋 iOS 開發與容器部署"
tags: [gitnexus, mcp, swift, docker]
topics: [agents.mcp]
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.95

GitNexus v1.6.6-rc.95 是自動化候選版本構建，包含五大功能改進：MCP 啟動兼容性增強與 CLI 指令懶加載、git 提交後自動重新索引且嵌入不丟失、HTTP 嵌入後端支持遠程與自託管部署、完整 Swift/iOS 支持（含 SPM 導入解析、隱式導入、構造函數判別）、Docker 容器化支持。並修復全局升級 ENOTEMPTY 錯誤、快取目錄權限問題、大倉庫解析快取分片。RC 系列用於 1.6.6 穩定版發布前的測試積累。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.95)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.95 \n Target base: 1.6.6 (rc #95 )\n Source commit (main): f18ff52 \n Release commit (versioned tree): 8a85abb \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
