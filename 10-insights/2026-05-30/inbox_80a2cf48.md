...
id: inbox_80a2cf48
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-93-3cf3]]"
title: "Release Candidate v1.6.6-rc.93"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.93
source: gitnexus-releases
published_at: 2026-05-30T05:45:42+00:00
fetched_at: 2026-05-31T00:45:17.082359+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.93 為自動化構建的首個 RC，涵蓋 MCP 啟動兼容性改進、CLI 懶加載、git 提交後自動重新索引與嵌入保留、HTTP 嵌入後端（遠程/自託hosted）、完整 Swift/iOS 支持、Docker 容器化，以及全局升級 ENOTEMPTY 修復、快取目錄權限調整、大倉庫解析快取分片等 bug 修復。"
key_points:
  - "MCP 兼容性與 CLI 懶加載強化"
  - "git 提交鉤點自動重新索引，嵌入不丟失"
  - "HTTP+Docker+Swift 多語言部署覆蓋"
tags: [gitnexus, mcp, swift-lang]
topics: [agents.mcp]
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.93

GitNexus v1.6.6-rc.93 為自動化構建的首個 RC，涵蓋 MCP 啟動兼容性改進、CLI 懶加載、git 提交後自動重新索引與嵌入保留、HTTP 嵌入後端（遠程/自託hosted）、完整 Swift/iOS 支持、Docker 容器化，以及全局升級 ENOTEMPTY 修復、快取目錄權限調整、大倉庫解析快取分片等 bug 修復。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.93)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.93 \n Target base: 1.6.6 (rc #93 )\n Source commit (main): bef3da5 \n Release commit (versioned tree): 88d246a \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
