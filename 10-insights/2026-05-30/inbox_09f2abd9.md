...
id: inbox_09f2abd9
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-98-97f3]]"
title: "Release Candidate v1.6.6-rc.98"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.98
source: gitnexus-releases
published_at: 2026-05-30T11:47:57+00:00
fetched_at: 2026-05-31T00:43:31.729191+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.98 發佈（源 commit a93ecee）。MCP 啟動相容性改進、lazy-load CLI；git commit 自動重新索引保留 embeddings、HTTP 遠端 embedding 後端；完整 Swift/Kotlin/PHP/Ruby 語言支援；Docker 支援。Bug 修正：全域升級 ENOTEMPTY 預安裝清理、cache directory user-writable、tree-sitter-proto 生命週期、parse cache sharding、MCP 並行工具呼叫崩潰防護。本 RC 為 1.6.6 穩定版前測試。"
key_points:
  - "MCP 啟動相容性 + lazy-load；KuzuDB/tree-sitter-proto 整合測試（#207, #209）"
  - "Git commit 自動重新索引保留 embeddings；HTTP embedding 後端遠端支援（#205, #395）"
  - "Swift/Kotlin/PHP/Ruby 完整支援、Docker、ENOTEMPTY/cache 修正、parse cache sharding、MCP 並行穩定性（#408, #848, #843-846, #1580, #326）"
tags: [gitnexus-release, release-candidate, multi-language]
topics: []
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.98

GitNexus v1.6.6-rc.98 發佈（源 commit a93ecee）。MCP 啟動相容性改進、lazy-load CLI；git commit 自動重新索引保留 embeddings、HTTP 遠端 embedding 後端；完整 Swift/Kotlin/PHP/Ruby 語言支援；Docker 支援。Bug 修正：全域升級 ENOTEMPTY 預安裝清理、cache directory user-writable、tree-sitter-proto 生命週期、parse cache sharding、MCP 並行工具呼叫崩潰防護。本 RC 為 1.6.6 穩定版前測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.98)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.98 \n Target base: 1.6.6 (rc #98 )\n Source commit (main): a93ecee \n Release commit (versioned tree): 6284f8f \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
