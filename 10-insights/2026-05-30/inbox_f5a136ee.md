...
id: inbox_f5a136ee
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-97-e719]]"
title: "Release Candidate v1.6.6-rc.97"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.97
source: gitnexus-releases
published_at: 2026-05-30T10:28:25+00:00
fetched_at: 2026-05-31T00:43:31.730742+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.97 發佈（源 commit 66daf27）。安全性改進 MPC 啟動相容性、lazy-load CLI；功能含 git commit 自動重新索引保留 embeddings、HTTP 遠端 embedding 後端、完整 Swift 支援（查詢修正、匯出檢測、隱式匯入、constructor 解析）、Docker 支援。Bug 修正：全域升級 ENOTEMPTY 防護、cache directory user-writable、parse cache sharding、Go O(n²) scope-capture 重新走遍消除。RC 版本供早期測試。"
key_points:
  - "MCP 相容性增強 + lazy-load CLI；KuzuDB 整合測試（#207, #209）"
  - "Git commit 自動重新索引保留 embeddings；HTTP embedding 後端支援遠端（#205, #395）"
  - "Swift 完整支援、Docker、ENOTEMPTY/cache 修正、parse cache sharding、O(n²) 消除（#408, #848, #843-846, #1580, #1915）"
tags: [gitnexus-release, release-candidate, performance]
topics: []
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.97

GitNexus v1.6.6-rc.97 發佈（源 commit 66daf27）。安全性改進 MPC 啟動相容性、lazy-load CLI；功能含 git commit 自動重新索引保留 embeddings、HTTP 遠端 embedding 後端、完整 Swift 支援（查詢修正、匯出檢測、隱式匯入、constructor 解析）、Docker 支援。Bug 修正：全域升級 ENOTEMPTY 防護、cache directory user-writable、parse cache sharding、Go O(n²) scope-capture 重新走遍消除。RC 版本供早期測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.97)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.97 \n Target base: 1.6.6 (rc #97 )\n Source commit (main): 66daf27 \n Release commit (versioned tree): 4bfeee9 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
