...
id: inbox_0ccfde44
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-101-a449]]"
title: "Release Candidate v1.6.6-rc.101"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.101
source: gitnexus-releases
published_at: 2026-05-30T19:20:34+00:00
fetched_at: 2026-05-31T00:43:31.704366+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.101 發佈，自動化建置（源 commit d1d2a64）。核心特性：MCP 啟動相容性改進、git commit 後自動重新索引保留 embeddings、HTTP 遠端 embedding 後端支援自託管端點。新增完整 Swift/Kotlin 語言支援、Docker 支援。Bug 修正涵蓋全域升級 ENOTEMPTY 防護、parse cache sharding 大型 repo 優化、Go O(n²) scope-capture 消除。RC 版本供早期社群測試，穩定版維持 latest dist-tag。"
key_points:
  - "MCP 啟動相容性增強 + lazy-load CLI；安全性 KuzuDB 整合測試（#207, #209）"
  - "Git commit 自動重新索引保留 embeddings；HTTP embedding 後端支援遠端自託管端點（#205, #395）"
  - "完整 Swift 支援（查詢修正、匯出檢測、constructor 解析）、Docker、O(n²) scope-capture 消除、全域升級 ENOTEMPTY 防護（#408, #848, #1915, #843）"
tags: [gitnexus-release, release-candidate, mcp, embeddings]
topics: []
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.101

GitNexus v1.6.6-rc.101 發佈，自動化建置（源 commit d1d2a64）。核心特性：MCP 啟動相容性改進、git commit 後自動重新索引保留 embeddings、HTTP 遠端 embedding 後端支援自託管端點。新增完整 Swift/Kotlin 語言支援、Docker 支援。Bug 修正涵蓋全域升級 ENOTEMPTY 防護、parse cache sharding 大型 repo 優化、Go O(n²) scope-capture 消除。RC 版本供早期社群測試，穩定版維持 latest dist-tag。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.101)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.101 \n Target base: 1.6.6 (rc #101 )\n Source commit (main): d1d2a64 \n Release commit (versioned tree): 23dffd3 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
