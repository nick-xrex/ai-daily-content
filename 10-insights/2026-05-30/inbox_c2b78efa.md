...
id: inbox_c2b78efa
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-100-c62a]]"
title: "Release Candidate v1.6.6-rc.100"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.100
source: gitnexus-releases
published_at: 2026-05-30T18:43:43+00:00
fetched_at: 2026-05-31T00:43:31.725777+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.100 發佈（源 commit d5514f5）。安全性改進 MCP 啟動相容性、lazy-load CLI 指令；功能含 git commit 自動重新索引保留 embeddings、HTTP 遠端 embedding 後端、完整 Swift/Kotlin 支援、Docker 支援。Bug 修正：全域升級 ENOTEMPTY 防護、cache directory user-writable、parse cache sharding 大型 repo、MCP 並行工具呼叫穩定性。RC 版本供測試。"
key_points:
  - "MCP 啟動相容性與 lazy-load CLI；KuzuDB 整合測試強化（#207, #209）"
  - "Git commit 自動重新索引保留 embeddings；HTTP embedding 後端支援遠端（#205, #395）"
  - "Swift/Kotlin 完整支援、Docker、ENOTEMPTY/cache 修正、MCP 並行穩定性（#408, #848, #843-845, #326）"
tags: [gitnexus-release, release-candidate, mcp]
topics: []
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.100

GitNexus v1.6.6-rc.100 發佈（源 commit d5514f5）。安全性改進 MCP 啟動相容性、lazy-load CLI 指令；功能含 git commit 自動重新索引保留 embeddings、HTTP 遠端 embedding 後端、完整 Swift/Kotlin 支援、Docker 支援。Bug 修正：全域升級 ENOTEMPTY 防護、cache directory user-writable、parse cache sharding 大型 repo、MCP 並行工具呼叫穩定性。RC 版本供測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.100)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.100 \n Target base: 1.6.6 (rc #100 )\n Source commit (main): d5514f5 \n Release commit (versioned tree): 40faad9 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
