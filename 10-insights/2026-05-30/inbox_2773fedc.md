...
id: inbox_2773fedc
date: 2026-05-30
source_ref: "[[00-inbox/2026-05-30/0039-gitnexus-releases-release-candidate-v1-6-6-rc-94-3f2d]]"
title: "Release Candidate v1.6.6-rc.94"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.94
source: gitnexus-releases
published_at: 2026-05-30T08:14:22+00:00
fetched_at: 2026-05-31T00:45:17.080813+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.94 繼 rc.93 後的自動化候選版本，包含相同的功能集：MCP 兼容性增強、auto-reindex-with-embeddings-preservation、HTTP 嵌入後端、完整 Swift 語言支持、Docker 支持及多項 bug 修復。該版本持續為 1.6.6 穩定版的測試反饋積累。"
key_points:
  - "MCP 啟動兼容性與 CLI 懶加載"
  - "git commit 後自動重新索引且嵌入保留"
  - "HTTP/Docker/Swift 支持擴展部署與開發場景"
tags: [gitnexus, mcp, release-candidate]
topics: [agents.mcp]
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.94

GitNexus v1.6.6-rc.94 繼 rc.93 後的自動化候選版本，包含相同的功能集：MCP 兼容性增強、auto-reindex-with-embeddings-preservation、HTTP 嵌入後端、完整 Swift 語言支持、Docker 支持及多項 bug 修復。該版本持續為 1.6.6 穩定版的測試反饋積累。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.94)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.94 \n Target base: 1.6.6 (rc #94 )\n Source commit (main): 5d71041 \n Release commit (versioned tree): 8d01823 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
