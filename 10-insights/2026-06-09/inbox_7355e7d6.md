...
id: inbox_7355e7d6
date: 2026-06-09
source_ref: "[[00-inbox/.../inbox_7355e7d6]]"
title: "Initial impressions of Claude Fable 5"
url: https://simonwillison.net/2026/Jun/9/claude-fable-5/#atom-everything
source: simon-willison
published_at: 2026-06-09T23:59:54+00:00
fetched_at: 2026-06-11T00:25:10.285349+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "Simon Willison 在 Fable 5 發布後進行了 5.5 小時深度評測。該文評測了 Fable 5 和同時發布的 Mythos 5 的核心指標：1M token context、128k max output tokens、2026 年 1 月知識截止、$10/M input + $50/M output 定價（Opus 的 2 倍）。在知識深度評測中，Fable 5 成功列舉 30+ 開源項目（Opus 4.8 僅列 6 項），暗示模型規模遠大。Simon 並透過實例展示 Fable 的工程能力——成功升級 micropython-wasm 為完整 CPython 實現，生成 13.9MB wheel 包，可一鍵執行。Simon 推測 Fable 可能是目前業界最大的前沿模型。"
key_points:
  - "Claude Fable 5 / Mythos 5 規格：1M context、128k max output、Jan 2026 知識截止、$10/$50 定價（Opus 2 倍），Fable 提供額外安全防護欄、Mythos 無分類器"
  - "知識深度對比：Fable 列舉 Simon Willison 30+ 開源項目（Opus 4.8 僅 6 項），暗示更大規模參數（可能業界最大）"
  - "實測工程能力：用 Fable 成功將 micropython-wasm 升級為完整 CPython 實現，生成 13.9MB 可執行 wheel 包，展示代碼理解和工程偵錯能力"
tags: [claude-fable, claude-mythos, model-evaluation, llm-performance, anthropic]
...
Simon Willison 在 Fable 5 發布後進行了 5.5 小時深度評測。該文評測了 Fable 5 和同時發布的 Mythos 5 的核心指標：1M token context、128k max output tokens、2026 年 1 月知識截止、$10/M input + $50/M output 定價（Opus 的 2 倍）。在知識深度評測中，Fable 5 成功列舉 30+ 開源項目（Opus 4.8 僅列 6 項），暗示模型規模遠大。Simon 並透過實例展示 Fable 的工程能力——成功升級 micropython-wasm 為完整 CPython 實現，生成 13.9MB wheel 包，可一鍵執行。Simon 推測 Fable 可能是目前業界最大的前沿模型。
...
**原文：** [simon-willison](https://simonwillison.net/2026/Jun/9/claude-fable-5/#atom-everything)
