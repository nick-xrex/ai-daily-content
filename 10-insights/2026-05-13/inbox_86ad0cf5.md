...
id: inbox_86ad0cf5
date: 2026-05-13
source_ref: "[[00-inbox/.../inbox_86ad0cf5]]"
title: "v2.1.141"
url: https://github.com/anthropics/claude-code/releases/tag/v2.1.141
source: claude-code-releases
published_at: 2026-05-13T23:19:16+00:00
fetched_at: 2026-05-18T03:27:38.968405+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "Claude Code v2.1.141 版本發布，涵蓋數十項功能增強與 bug 修復。重點新增 terminalSequence 字段支持 hook 在無控制終端時發送桌面通知與視窗標題；新增 CLAUDE_CODE_PLUGIN_PREFER_HTTPS 與 ANTHROPIC_WORKSPACE_ID 環境變數改進 GitHub SSH 與工作負載身份聯邦；改進代理色彩、權限対話説明、長思考期間的 spinner 反饋，以及 vim 模式中 Ctrl+C 中斷等多個 UI/UX 細節；修復了 Bedrock/Vertex 上的 Haiku 模型回退、Windows daemon 狀態查詢、背景作業權限模式保留、markdown 表格換行渲染等共逾 50 項邊界情況。"
key_points:
  - "新增 terminalSequence 字段讓 hook 不依賴控制終端發送桌面通知、視窗標題與鈴聲"
  - "支援 ANTHROPIC_WORKSPACE_ID 環境變數實現工作負載身份聯邦下的多 workspace 作用域"
  - "修復 50+ 項邊界情況，包括背景服務啟動、設定檔符號連結重載、vim 模式中斷與權限模式保留"
tags: [claude-code-release, cli-enhancement, environment-variables, bug-fix]
...
Claude Code v2.1.141 版本發布，涵蓋數十項功能增強與 bug 修復。重點新增 terminalSequence 字段支持 hook 在無控制終端時發送桌面通知與視窗標題；新增 CLAUDE_CODE_PLUGIN_PREFER_HTTPS 與 ANTHROPIC_WORKSPACE_ID 環境變數改進 GitHub SSH 與工作負載身份聯邦；改進代理色彩、權限対話説明、長思考期間的 spinner 反饋，以及 vim 模式中 Ctrl+C 中斷等多個 UI/UX 細節；修復了 Bedrock/Vertex 上的 Haiku 模型回退、Windows daemon 狀態查詢、背景作業權限模式保留、markdown 表格換行渲染等共逾 50 項邊界情況。
...
**原文：** [claude-code-releases](https://github.com/anthropics/claude-code/releases/tag/v2.1.141)
