...
id: inbox_e8ff344c
date: 2026-05-23
source_ref: "[[00-inbox/.../inbox_e8ff344c]]"
title: "Release Candidate v1.6.6-rc.47"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.47
source: gitnexus-releases
published_at: 2026-05-23T08:11:02+00:00
fetched_at: 2026-05-24T04:26:46.776194+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.47 發布候選版本，包含與 rc.48 相同的 Kotlin 型別系統 5 項修復、JavaScript scope-based resolution 遷移、C++ 約束擴展、DeepSeek V4 API 支持。新增多語言支持（--lang flags）、Git worktree 支持、GitLab 倉庫整合。性能優化：owner-keyed member resolution lookup、zero-copy ingestion worker pool、WAL checkpoint threshold 控制。Windows 相容性修復（FTS probe、Cypher 讀寫分離）。此版本為舊版 RC，已被 rc.48 取代。"
key_points:
  - "Kotlin/JavaScript/C++ 型別解析 5+ 項改進、DeepSeek V4 API 支持"
  - "owner-keyed lookup、zero-copy worker pool、FTS 修復、WAL checkpoint 控制"
  - "多語言 wiki（--lang）、Git worktree、GitLab、Windows 相容性強化"
tags: [gitnexus, rc-release, type-system, multi-language]
topics: []
importance: 2
novelty: 2
insight_quality: 3
...
## Release Candidate v1.6.6-rc.47

GitNexus v1.6.6-rc.47 發布候選版本，包含與 rc.48 相同的 Kotlin 型別系統 5 項修復、JavaScript scope-based resolution 遷移、C++ 約束擴展、DeepSeek V4 API 支持。新增多語言支持（--lang flags）、Git worktree 支持、GitLab 倉庫整合。性能優化：owner-keyed member resolution lookup、zero-copy ingestion worker pool、WAL checkpoint threshold 控制。Windows 相容性修復（FTS probe、Cypher 讀寫分離）。此版本為舊版 RC，已被 rc.48 取代。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.47)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.47 \n Target base: 1.6.6 (rc #47 )\n Source commit (main): fb94dba \n Release commit (versioned tree): a0ee408 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.5...v1.6.6-rc.47
