...
id: inbox_2f8d1310
date: 2026-07-23
source_ref: "[[00-inbox/2026-07-23/0148-gitnexus-releases-release-candidate-v1-6-10-rc-91-41e8]]"
title: "Release Candidate v1.6.10-rc.91"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.91
source: gitnexus-releases
published_at: 2026-07-23T06:12:32+00:00
fetched_at: 2026-07-24T01:55:37.634034+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.91 發佈，RC cycle 中的第一個 build。發佈說明與 rc.92/rc.93 相同，顯示連續三個 RC 使用相同發佈清單。核心變更包括 Phase 8 類型解析、MCP 相容性改進、Swift/Docker/HTTP embedding 支持、多項穩定性和性能修復（O(n²) scope-capture 消除、parse cache 持久化、MCP 並行崩潰修復）。KuzuDB fork crashes 測試覆蓋已加強。"
key_points:
  - "rc.91–rc.93 連續三個 build 使用相同發佈說明 — 表示變更集最後確定、微調 build 流程"
  - "Phase 8 字段解析、ACCESSES 邊追蹤 — 支援 10+ 語言的類型推論達成"
  - "性能改進：消除 O(n²) scope-capture re-walks；穩定性：MCP 並行崩潰修復、升級 ENOTEMPTY 處理"
tags: [code-analysis, type-resolution, multi-language, mcp-stability]
topics: [agents.mcp]
importance: 3
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.10-rc.91

GitNexus v1.6.10-rc.91 發佈，RC cycle 中的第一個 build。發佈說明與 rc.92/rc.93 相同，顯示連續三個 RC 使用相同發佈清單。核心變更包括 Phase 8 類型解析、MCP 相容性改進、Swift/Docker/HTTP embedding 支持、多項穩定性和性能修復（O(n²) scope-capture 消除、parse cache 持久化、MCP 並行崩潰修復）。KuzuDB fork crashes 測試覆蓋已加強。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.91)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.91 \n Target base: 1.6.10 (rc #91 )\n Source commit (main): ebc2810 \n Release commit (versioned tree): 75e2060 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
