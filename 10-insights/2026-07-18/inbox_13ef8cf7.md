...
id: inbox_13ef8cf7
date: 2026-07-18
source_ref: "[[00-inbox/.../inbox_13ef8cf7]]"
title: "Release Candidate v1.6.10-rc.46"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.46
source: gitnexus-releases
published_at: 2026-07-18T07:59:56+00:00
fetched_at: 2026-07-20T00:37:28.371764+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.46 發佈，v1.6.10 RC 系列早期版本。包含 CodeBuddy/Qoder 編碼代理整合、完整 Codex 支援、決定性和 MCP 政策標準化（fail-closed 唯讀模式、參數別名、響應預算）。修復涵蓋 embeddings 自癒、FTS 擴展診斷、Windows 跨平台穩定性、符號內容精確匹配。"
key_points:
  - "CodeBuddy、Qoder 代理整合 + Codex 支援"
  - "MCP 政策系列：fail-closed 模式、參數標準化、決定性響應預算"
  - "Windows 穩定性修復：FTS 診斷、embeddings 自癒、NUL 字節恢復"
...
## Release Candidate v1.6.10-rc.46

GitNexus v1.6.10-rc.46 發佈，v1.6.10 RC 系列早期版本。包含 CodeBuddy/Qoder 編碼代理整合、完整 Codex 支援、決定性和 MCP 政策標準化（fail-closed 唯讀模式、參數別名、響應預算）。修復涵蓋 embeddings 自癒、FTS 擴展診斷、Windows 跨平台穩定性、符號內容精確匹配。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.46)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.46 \n Target base: 1.6.10 (rc #46 )\n Source commit (main): 4d7a0a6 \n Release commit (versioned tree): 1ef07c1 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.46
