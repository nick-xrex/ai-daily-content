...
id: inbox_b7ae62bd
date: 2026-07-18
source_ref: "[[00-inbox/.../inbox_b7ae62bd]]"
title: "Release Candidate v1.6.10-rc.47"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.47
source: gitnexus-releases
published_at: 2026-07-18T13:46:03+00:00
fetched_at: 2026-07-20T00:37:28.371082+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.47 發佈，RC 連續迭代版本。功能集與 rc.48 基本相同，差異為缺少後續 PR（Dart extension types 等）。主要功能為 CodeBuddy/Qoder 整合、完整 Codex 支援、決定性和 MCP 政策系列（fail-closed 唯讀模式、參數標準化、響應預算）、Windows 穩定性修復套件。"
key_points:
  - "CodeBuddy、Qoder + Codex 支援與 MCP 政策標準化"
  - "決定性和 MCP 政策系列：fail-closed 模式、參數別名標準化、響應預算控制"
  - "Windows 穩定性修復套件（FTS、embeddings、NUL 字節解析）"
...
## Release Candidate v1.6.10-rc.47

GitNexus v1.6.10-rc.47 發佈，RC 連續迭代版本。功能集與 rc.48 基本相同，差異為缺少後續 PR（Dart extension types 等）。主要功能為 CodeBuddy/Qoder 整合、完整 Codex 支援、決定性和 MCP 政策系列（fail-closed 唯讀模式、參數標準化、響應預算）、Windows 穩定性修復套件。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.47)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.47 \n Target base: 1.6.10 (rc #47 )\n Source commit (main): 1abcac9 \n Release commit (versioned tree): 9fbb9ac \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.9...v1.6.10-rc.47
