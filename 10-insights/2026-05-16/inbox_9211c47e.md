...
id: inbox_9211c47e
date: 2026-05-16
source_ref: "[[00-inbox/2026-05-16/1800-hermes-agent-releases-hermes-agent-v0-14-0-2026-5-16-ad02]]"
...
fetched_at: 2026-05-22T18:08:46.099870+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "Hermes Agent v0.14.0 Foundation Release（自上版 808 commits、545 closed issues 含 12 P0）核心擴展：①xAI Grok via SuperGrok OAuth 支援 1M context window ②OpenAI-compatible 本地代理讓 Codex/Aider/Cline 無 API key 可用 ③x_search 推特整合 ④Microsoft Teams 端對端通道。安裝輕量化：pip install hermes-agent、重型後端自動 lazy-install、冷啟動減 ~19 秒。效能優化：跨會話 1 小時 Claude prompt 快取成本優化、browser CDP 加速 180 倍。訊息平台擴至 22 個，新增 LINE 和 SimpleX Chat，/handoff 實時轉移會話上下文。"
key_points:
  - "OpenAI-compatible 本地代理統一 OAuth providers（Claude Pro/ChatGPT Pro/SuperGrok），讓任何工具無 API key 可用"
  - "Cross-session 1 小時 Claude prompt 快取 + browser CDP 180 倍加速，顯著降低成本和延遲"
  - "Lazy-install 架構（重型後端首次使用自動裝置、冷啟動減 ~19 秒）+ 22 個訊息平台統一層"
tags: [oauth-providers, local-proxy, prompt-caching, lazy-loading, multi-platform]
topics: []
importance: 5
novelty: 4
insight_quality: 4
...
**原文：** [hermes-agent-releases](https://github.com/NousResearch/hermes-agent/releases/tag/v2026.5.16)
