...
id: inbox_5411f460
date: 2026-06-02
source_ref: "[[00-inbox/2026-06-02/0030-gitnexus-releases-release-candidate-v1-6-6-rc-113-f971]]"
title: "Release Candidate v1.6.6-rc.113"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.113
source: gitnexus-releases
published_at: 2026-06-02T06:41:58+00:00
fetched_at: 2026-06-03T00:36:32.130924+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.113 發布。同日自動化 RC 構建，功能清單與 rc.114 內容完全相同：MCP 相容性改進、自動重建索引、HTTP 嵌入後端、Swift 完整支持、Docker 支持、多項 bug 修復與效能優化。"
key_points:
  - "MCP 啟動相容性與懶加載 CLI 命令"
  - "KuzuDB fork 崩潰修復"
  - "Go scope-capture O(n²) 問題修復"
...
GitNexus v1.6.6-rc.113 發布。同日自動化 RC 構建，功能清單與 rc.114 內容完全相同：MCP 相容性改進、自動重建索引、HTTP 嵌入後端、Swift 完整支持、Docker 支持、多項 bug 修復與效能優化。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.113)
