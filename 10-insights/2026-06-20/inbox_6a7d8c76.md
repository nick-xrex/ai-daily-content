...
id: inbox_6a7d8c76
date: 2026-06-20
source_ref: "[[00-inbox/.../inbox_6a7d8c76]]"
title: "Release Candidate v1.6.8-rc.58"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.58
source: gitnexus-releases
published_at: 2026-06-20T19:59:49+00:00
fetched_at: 2026-06-21T02:26:57.004025+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.8-rc.58 發布為最後衝刺的預穩定版本。安全性方面修復 MCP 啟動相容性問題和 KuzuDB fork 崩潰。新功能包括 git hooks 自動重新索引（保留嵌入式）、HTTP 嵌入式後端支援自託管遠端端點。Swift 語言支援完成，包括查詢修復、匯出檢測和隱含匯入。CLI 新增 index 命令用於登記現有 .gitnexus/ 資料夾。Docker 支援已實現。修復諸多錯誤如安裝清理防止 ENOTEMPTY、快取目錄設定、Go 中 O(n²) 作用域捕獲優化、大型倉庫解析穩定性。"
key_points:
  - "安全修復：MCP 啟動相容性改善、KuzuDB fork 崩潰與整合測試強化"
  - "新功能：git hooks 自動重新索引（保留嵌入式）、HTTP 嵌入式後端、Swift 完整支援、Docker 支援、CLI index 命令"
  - "效能與穩定性：Go O(n²) 作用域捕獲優化、大型倉庫解析、安裝清理和快取目錄修復"
tags: [gitnexus, v1.6.8-rc, release-candidate, multi-feature]
topics: []
importance: 3
novelty: 2
insight_quality: 2
...
## Release Candidate v1.6.8-rc.58

GitNexus v1.6.8-rc.58 發布為最後衝刺的預穩定版本。安全性方面修復 MCP 啟動相容性問題和 KuzuDB fork 崩潰。新功能包括 git hooks 自動重新索引（保留嵌入式）、HTTP 嵌入式後端支援自託管遠端端點。Swift 語言支援完成，包括查詢修復、匯出檢測和隱含匯入。CLI 新增 index 命令用於登記現有 .gitnexus/ 資料夾。Docker 支援已實現。修復諸多錯誤如安裝清理防止 ENOTEMPTY、快取目錄設定、Go 中 O(n²) 作用域捕獲優化、大型倉庫解析穩定性。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.58)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.58 \n Target base: 1.6.8 (rc #58 )\n Source commit (main): 2399671 \n Release commit (versioned tree): 20f7cd6 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 feat(wiki): add Cursor CLI as LLM provider opt
