...
id: inbox_696745cc
date: 2026-06-22
source_ref: "[[00-inbox/2026-06-22/2200-codex-releases-0-142-0-6876]]"
title: "0.142.0"
url: https://github.com/openai/codex/releases/tag/rust-v0.142.0
source: codex-releases
published_at: 2026-06-22T22:21:19+00:00
fetched_at: 2026-06-23T22:05:01.529453+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "OpenAI Codex 0.142.0 版本推出多項代理編程與代幣管理功能，增強多代理協作能力。新增 /usage 信用兌換、/plugins 遠程外掛組織（OpenAI 精選/工作區/共享三層結構）、可配置代幣預算追蹤、多代理委託控制（支援禁用/明確請求/主動三模式）、索引網路搜索模式與 UTC 時間提醒等特性。修復 Linux TUI 暫停恢復穩定性、exec-server 會話在瞬間斷開後的存活能力、遠程環境跨平台路徑與沙箱行為保持一致。性能優化包括啟動延遲減少與日誌精簡，改善整體系統效能。此版本大幅提升多代理系統的可用性與穩定性。"
key_points:
  - "實現代幣預算與多代理委託控制，在執行緒/轉向層級支援禁用/明確請求/主動三模式配置"
  - "新增索引網路搜索模式允許即時搜索同時限制直接頁面存取，提升搜索靈活性與安全性"
  - "修復 exec-server 進程瞬間斷開存活能力與遠程環境跨 OS 相容性（路徑、shell、沙箱行為保持）"
tags: [codex, openai, release, agents, mcp]
...
OpenAI Codex 0.142.0 版本推出多項代理編程與代幣管理功能，增強多代理協作能力。新增 /usage 信用兌換、/plugins 遠程外掛組織（OpenAI 精選/工作區/共享三層結構）、可配置代幣預算追蹤、多代理委託控制（支援禁用/明確請求/主動三模式）、索引網路搜索模式與 UTC 時間提醒等特性。修復 Linux TUI 暫停恢復穩定性、exec-server 會話在瞬間斷開後的存活能力、遠程環境跨平台路徑與沙箱行為保持一致。性能優化包括啟動延遲減少與日誌精簡，改善整體系統效能。此版本大幅提升多代理系統的可用性與穩定性。
...
**原文：** [codex-releases](https://github.com/openai/codex/releases/tag/rust-v0.142.0)
...
New Features 
 ...
 #29255 [codex] add configurable token budget compactio
