...
id: inbox_1c01298b
date: 2026-08-10
source_ref: "[[00-inbox/2026-08-10/2207-gitnexus-releases-release-candidate-v1-6-10-rc-186-6d9d]]"
title: "Release Candidate v1.6.10-rc.186"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.186
source: gitnexus-releases
published_at: 2026-08-10T21:09:05+00:00
fetched_at: 2026-08-11T00:10:17.676983+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.186 是同日稍早發布的 RC 版本（commit 5cfa402），發布時間 2026-08-10T21:09:05。包含與 rc.187 相同的功能特性：MCP 相容性改善、HTTP 嵌入後端、Swift 完整支援、Docker 支援、自動重新索引。安全修復涵蓋 MCP 啟動相容性、CLI 延遲載入、KuzuDB 穩定性改善。性能改善包括 Go 作用域 O(n²) 複雜度優化、ENOTEMPTY 全局升級清理。Bug 修復涵蓋快取目錄位置修正、大倉庫快取分片持久化。此版本已被最新的 rc.187 取代。"
key_points:
  - "同 rc.187 功能集：MCP 相容性、HTTP 嵌入、Swift 完整支援、Docker 支援、自動重新索引"
  - "Go 作用域 O(n²) 優化；ENOTEMPTY 全局升級清理；KuzuDB fork crash 修復"
tags: [code-indexing, language-support, mcp-integration, performance, docker-support]
topics: []
importance: 2
novelty: 2
insight_quality: 1
...
## Release Candidate v1.6.10-rc.186

GitNexus v1.6.10-rc.186 是同日稍早發布的 RC 版本（commit 5cfa402），發布時間 2026-08-10T21:09:05。包含與 rc.187 相同的功能特性：MCP 相容性改善、HTTP 嵌入後端、Swift 完整支援、Docker 支援、自動重新索引。安全修復涵蓋 MCP 啟動相容性、CLI 延遲載入、KuzuDB 穩定性改善。性能改善包括 Go 作用域 O(n²) 複雜度優化、ENOTEMPTY 全局升級清理。Bug 修復涵蓋快取目錄位置修正、大倉庫快取分片持久化。此版本已被最新的 rc.187 取代。

### 重點
- 同 rc.187 功能集：MCP 相容性、HTTP 嵌入、Swift 完整支援、Docker 支援、自動重新索引
- Go 作用域 O(n²) 優化；ENOTEMPTY 全局升級清理；KuzuDB fork crash 修復

**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.186)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.186 \n Target base: 1.6.10 (rc #186 )\n Source commit (main): 5cfa402 \n Release commit (versioned tree): de34540 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
