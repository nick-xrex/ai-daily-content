...
id: inbox_d15aa3fc
date: 2026-06-13
source_ref: "[[00-inbox/2026-06-13/2200-simon-willison-publishing-wasm-wheels-to-pypi-for-use-w-031e]]"
...
published_at: 2026-06-13T23:55:18+00:00
fetched_at: 2026-06-14T22:04:37.213390+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "Simon Willison 報導 Pyodide 314.0 釋出重大特性：支援 WASM wheels 原生發布到 PyPI，無需 Pyodide 維護者人工審核與託管。過去 300+ 套件被 Pyodide 團隊維護，形成重大瓶頸；現開發者可如發布 Linux/macOS/Windows wheels 般發布 Pyodide wheels，PEP 783 定義 PyEmscripten 平台標準。Simon 以 luau-wasm（Roblox Lua 方言編譯 WASM，276KB）作示範，經 GitHub Actions 自動構建發布到 PyPI，可在 Pyodide REPL 中 `import luau_wasm` 直接執行。BigQuery 統計：已有 28 套件使用 pyemscripten_202*_wasm32 標籤，包括 ONNX、pydantic_core、yaml-rs、typst、robotraconteur 等重要專案。"
key_points:
  - "Pyodide 314.0 解除 WASM wheels PyPI 發布限制，開發者可自行構建發布（PEP 783），降低 300+ 套件維護負擔"
  - "已有 28 個套件採用 pyemscripten_202*_wasm32 標籤：ONNX、pydantic_core、robotraconteur、typst、yaml-rs、base64_utils 等核心生態套件"
  - "luau-wasm 示範完整流程：C++ 源碼 → cibuildwheel WASM 編譯 → GitHub Actions 自動發布 → 線上互動式示範，成為 WASM Python 套件發布範本"
tags: [pyodide, wasm, pypi, python-ecosystem, distribution]
topics: []
importance: 3
novelty: 4
insight_quality: 3
...
Simon Willison 報導 Pyodide 314.0 釋出重大特性：支援 WASM wheels 原生發布到 PyPI，無需 Pyodide 維護者人工審核與託管。過去 300+ 套件被 Pyodide 團隊維護，形成重大瓶頸；現開發者可如發布 Linux/macOS/Windows wheels 般發布 Pyodide wheels，PEP 783 定義 PyEmscripten 平台標準。Simon 以 luau-wasm（Roblox Lua 方言編譯 WASM，276KB）作示範，經 GitHub Actions 自動構建發布到 PyPI，可在 Pyodide REPL 中 `import luau_wasm` 直接執行。BigQuery 統計：已有 28 套件使用 pyemscripten_202*_wasm32 標籤，包括 ONNX、pydantic_core、yaml-rs、typst、robotraconteur 等重要專案。
...
**原文：** [simon-willison](https://simonwillison.net/2026/Jun/13/publishing-wasm-wheels/#atom-everything)
