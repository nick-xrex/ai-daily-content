...
id: inbox_37e2feec
date: 2026-06-13
source_ref: "[[00-inbox/2026-06-13/2200-gitnexus-releases-release-candidate-v1-6-8-rc-29-850f]]"
title: "Release Candidate v1.6.8-rc.29"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.29
source: gitnexus-releases
published_at: 2026-06-13T11:09:31+00:00
fetched_at: 2026-06-13T22:04:06.582855+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.8-rc.29 發佈，為 1.6.8 版本的第 29 個預發佈候選。包含多分支索引、MCP HTTP 伺服器、向量索引修復、Docker 資源部署等功能。相較 rc.30，缺少後續新增的嵌入基址自訂參數。"
key_points:
  - "多分支索引與分支範圍查詢支援"
  - "MCP HTTP 伺服器實裝與 Claude Code 相容性"
  - "影響範圍分析（blast radius）修復與大型儲存庫穩定性改善"
...
## Release Candidate v1.6.8-rc.29

GitNexus v1.6.8-rc.29 發佈，為 1.6.8 版本的第 29 個預發佈候選。包含多分支索引、MCP HTTP 伺服器、向量索引修復、Docker 資源部署等功能。相較 rc.30，缺少後續新增的嵌入基址自訂參數。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.29)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.29 \n Target base: 1.6.8 (rc #29 )\n Source commit (main): 9122850 \n Release commit (versioned tree): 0b4ebf9 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.29
