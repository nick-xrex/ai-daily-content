...
id: inbox_16daeb8a
date: 2026-06-13
source_ref: "[[00-inbox/2026-06-13/2200-gitnexus-releases-release-candidate-v1-6-8-rc-28-c3c1]]"
title: "Release Candidate v1.6.8-rc.28"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.28
source: gitnexus-releases
published_at: 2026-06-13T10:26:17+00:00
fetched_at: 2026-06-13T22:04:06.584783+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.8-rc.28 發佈，為 1.6.8 版本的第 28 個預發佈候選。包含多分支索引、MCP HTTP 伺服器、向量索引修復、Java Spring 支援、Docker 資源部署等功能。相較 rc.29，缺少後續新增的效能最佳化與淨化措施。"
key_points:
  - "多分支索引與分支查詢功能初步實裝"
  - "MCP HTTP 伺服器與 Claude Code 整合"
  - "向量索引、Docker 部署、Java 框架支援改善"
tags: [gitnexus, mcp-integration, multi-branch, code-analysis, release-candidate]
topics: [agents.mcp]
importance: 2
novelty: 1
insight_quality: 2
...
## Release Candidate v1.6.8-rc.28

GitNexus v1.6.8-rc.28 發佈，為 1.6.8 版本的第 28 個預發佈候選。包含多分支索引、MCP HTTP 伺服器、向量索引修復、Java Spring 支援、Docker 資源部署等功能。相較 rc.29，缺少後續新增的效能最佳化與淨化措施。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.28)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.28 \n Target base: 1.6.8 (rc #28 )\n Source commit (main): 6dc6544 \n Release commit (versioned tree): 0905b6a \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.28
