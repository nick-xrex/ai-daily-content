...
id: inbox_c5fa2a00
date: 2026-05-28
source_ref: "[[00-inbox/2026-05-28/0000-gitnexus-releases-release-candidate-v1-6-6-rc-80-23d7]]"
title: "Release Candidate v1.6.6-rc.80"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.80
source: gitnexus-releases
published_at: 2026-05-28T15:38:24+00:00
fetched_at: 2026-05-29T00:05:51.494197+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.80 發布，多項功能強化。支援 HTTP 嵌入後端（自託管/遠端端點），完整 Swift 語言支持、Docker 部署、CLI 'index' 指令用於註冊現有索引資料夾。數據庫遷移自 KuzuDB 至 LadybugDB v0.15；Phase 4-9 類型解析系統覆蓋 10+ 程式語言（Ruby、PHP/Laravel、Kotlin 等）；新增 ACCESSES edge 用於讀/寫字段訪問追蹤。修復包含升級時 ENOTEMPTY 錯誤、緩存目錄權限問題、大型倉庫解析緩存分片。MCP 啟動兼容性改進，git commit 後自動重新索引並保留嵌入。"
key_points:
  - "支援 HTTP 嵌入後端與 Docker 部署，擴展自託管和遠端使用場景"
  - "KuzuDB → LadybugDB v0.15 遷移 + Phase 4-9 類型推斷系統覆蓋 10+ 語言（Swift、Ruby、PHP、Kotlin）"
  - "修復升級時 ENOTEMPTY 錯誤、緩存目錄權限、大型倉庫解析崩潰"
tags: [gitnexus, code-intelligence, language-support, type-resolution, mcp-integration]
topics: []
importance: 3
novelty: 2
insight_quality: 2
...
## Release Candidate v1.6.6-rc.80

GitNexus v1.6.6-rc.80 發布，多項功能強化。支援 HTTP 嵌入後端（自託管/遠端端點），完整 Swift 語言支持、Docker 部署、CLI 'index' 指令用於註冊現有索引資料夾。數據庫遷移自 KuzuDB 至 LadybugDB v0.15；Phase 4-9 類型解析系統覆蓋 10+ 程式語言（Ruby、PHP/Laravel、Kotlin 等）；新增 ACCESSES edge 用於讀/寫字段訪問追蹤。修復包含升級時 ENOTEMPTY 錯誤、緩存目錄權限問題、大型倉庫解析緩存分片。MCP 啟動兼容性改進，git commit 後自動重新索引並保留嵌入。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.80)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.80 \n Target base: 1.6.6 (rc #80 )\n Source commit (main): 11fc43b \n Release commit (versioned tree): 602a724 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
