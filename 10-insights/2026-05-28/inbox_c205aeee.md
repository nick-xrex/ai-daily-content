...
id: inbox_c205aeee
date: 2026-05-28
source_ref: "[[00-inbox/2026-05-28/0000-gitnexus-releases-release-candidate-v1-6-6-rc-79-e798]]"
title: "Release Candidate v1.6.6-rc.79"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.79
source: gitnexus-releases
published_at: 2026-05-28T07:37:28+00:00
fetched_at: 2026-05-29T00:05:51.496404+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.79 發布（自動化 RC 構建）。功能同 rc.80：HTTP 嵌入後端、Docker 支援、Swift/Ruby/PHP 完整語言支持、KuzuDB → LadybugDB v0.15 遷移、Phase 4-9 類型解析、MCP 啟動兼容性改進。修復升級相關 ENOTEMPTY 錯誤、緩存目錄、大型倉庫解析캐시分片。"
key_points:
  - "HTTP 嵌入後端與 Docker 支援，擴展自託管部署能力"
  - "LadybugDB v0.15 遷移 + 10+ 語言類型推斷系統（Swift、Ruby、PHP、Kotlin）"
  - "修復升級時關鍵錯誤（ENOTEMPTY）和大型倉庫效能問題"
tags: [gitnexus, release-candidate, language-support, database-migration]
topics: []
importance: 3
novelty: 1
insight_quality: 2
...
## Release Candidate v1.6.6-rc.79

GitNexus v1.6.6-rc.79 發布（自動化 RC 構建）。功能同 rc.80：HTTP 嵌入後端、Docker 支援、Swift/Ruby/PHP 完整語言支持、KuzuDB → LadybugDB v0.15 遷移、Phase 4-9 類型解析、MCP 啟動兼容性改進。修復升級相關 ENOTEMPTY 錯誤、緩存目錄、大型倉庫解析캐시分片。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.79)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.79 \n Target base: 1.6.6 (rc #79 )\n Source commit (main): 50715e3 \n Release commit (versioned tree): 5dc3bc6 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
