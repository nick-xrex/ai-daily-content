...
id: inbox_37fb9a4b
date: 2026-05-28
source_ref: "[[00-inbox/2026-05-28/0000-gitnexus-releases-release-candidate-v1-6-6-rc-78-0f73]]"
title: "Release Candidate v1.6.6-rc.78"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.78
source: gitnexus-releases
published_at: 2026-05-28T06:26:57+00:00
fetched_at: 2026-05-29T00:05:51.496747+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.78 發布。內容與 rc.79、rc.80 基本相同，為自動化快速迭代的 RC 版本。核心功能：HTTP 嵌入後端、Docker 支援、Swift/Ruby/PHP/Kotlin 語言支持、KuzuDB → LadybugDB 遷移、多階段類型解析、MCP 兼容性改進、自動重索引。修復升級時文件系統錯誤與效能問題。"
key_points:
  - "HTTP 嵌入後端與 Docker 部署選項"
  - "LadybugDB v0.15 + Phase 4-9 多語言類型推斷（Swift、Ruby、PHP、Kotlin）"
  - "升級穩定性修復與大型倉庫解析優化"
tags: [gitnexus, release-candidate, stability-fixes, language-support]
topics: []
importance: 3
novelty: 1
insight_quality: 2
...
## Release Candidate v1.6.6-rc.78

GitNexus v1.6.6-rc.78 發布。內容與 rc.79、rc.80 基本相同，為自動化快速迭代的 RC 版本。核心功能：HTTP 嵌入後端、Docker 支援、Swift/Ruby/PHP/Kotlin 語言支持、KuzuDB → LadybugDB 遷移、多階段類型解析、MCP 兼容性改進、自動重索引。修復升級時文件系統錯誤與效能問題。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.78)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.78 \n Target base: 1.6.6 (rc #78 )\n Source commit (main): ca95df6 \n Release commit (versioned tree): a8a686c \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
