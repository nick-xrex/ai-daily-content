...
id: inbox_02eb5976
date: 2026-05-28
source_ref: "[[00-inbox/2026-05-28/0000-gitnexus-releases-release-candidate-v1-6-6-rc-81-fef3]]"
title: "Release Candidate v1.6.6-rc.81"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.81
source: gitnexus-releases
published_at: 2026-05-28T16:45:00+00:00
fetched_at: 2026-05-29T00:05:12.164616+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.81 RC 版本與 rc.82 內容基本相同，為自動化 RC 組建。涵蓋 KuzuDB → LadybugDB v0.15 遷移、Swift 完整支援、HTTP embedding backend、Docker、auto-reindex with embeddings、Phase 4–9 type resolution、DeepSeek 模型、多項 bug 修復等內容與 rc.82 重複。"
key_points:
  - "內容與 rc.82 幾乎完全相同，為連續自動化 RC 組建"
  - "涵蓋 LadybugDB 遷移、Swift 支援、HTTP embedding、Docker、auto-reindex"
  - "無獨有創新點或改進"
tags: [gitnexus, rc-build, automated-release]
topics: [agents.mcp]
importance: 4
novelty: 1
insight_quality: 2
...
## Release Candidate v1.6.6-rc.81

GitNexus v1.6.6-rc.81 RC 版本與 rc.82 內容基本相同，為自動化 RC 組建。涵蓋 KuzuDB → LadybugDB v0.15 遷移、Swift 完整支援、HTTP embedding backend、Docker、auto-reindex with embeddings、Phase 4–9 type resolution、DeepSeek 模型、多項 bug 修復等內容與 rc.82 重複。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.81)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.81 \n Target base: 1.6.6 (rc #81 )\n Source commit (main): 97c1f85 \n Release commit (versioned tree): 33b1a79 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
