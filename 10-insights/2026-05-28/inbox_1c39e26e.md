...
id: inbox_1c39e26e
date: 2026-05-28
source_ref: "[[00-inbox/2026-05-28/0000-gitnexus-releases-release-candidate-v1-6-6-rc-82-7fd1]]"
title: "Release Candidate v1.6.6-rc.82"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.82
source: gitnexus-releases
published_at: 2026-05-28T18:27:20+00:00
fetched_at: 2026-05-29T00:05:12.164333+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.82 完成資料庫後端遷移（KuzuDB → LadybugDB v0.15），支援 Swift 完整支援（查詢修復、匯出檢測、隱含匯入、建構子解析）。新增 HTTP embedding backend 自託管/遠端端點、Docker 容器支援、git commit 後自動重新索引且保留 embeddings、index 命令註冊現有 .gitnexus/ 資料夾。Phase 4–9 type resolution 系統涵蓋可空值展開、for 迴圈型態推論、模式匹配、field/property 型態推論，支援 10+ 語言。新增 DeepSeek 模型設定、.gitignore/.gitnexusignore 尊重、MCP 啟動相容性改善、整合測試覆蓋。Bug 修復包括全域升級 ENOTEMPTY 錯誤、大型儲存庫解析快取持久化、Swift 解析器可用性篩選等。"
key_points:
  - "KuzuDB → LadybugDB v0.15 遷移；Swift 完整支援（查詢、匯出檢測、隱含匯入、建構子）；HTTP embedding backend + Docker 支援"
  - "git commit 後自動重新索引保留 embeddings；Phase 4–9 type resolution 涵蓋 10+ 語言、可空值展開、for 迴圈、模式匹配、field/property 型態"
  - "新增 DeepSeek 模型、MCP startup 相容性改善、整合測試覆蓋、.gitignore/.gitnexusignore 尊重"
tags: [gitnexus, type-resolution, database-migration, docker, auto-reindex]
topics: [agents.mcp]
importance: 4
novelty: 4
insight_quality: 4
...
## Release Candidate v1.6.6-rc.82

GitNexus v1.6.6-rc.82 完成資料庫後端遷移（KuzuDB → LadybugDB v0.15），支援 Swift 完整支援（查詢修復、匯出檢測、隱含匯入、建構子解析）。新增 HTTP embedding backend 自託管/遠端端點、Docker 容器支援、git commit 後自動重新索引且保留 embeddings、index 命令註冊現有 .gitnexus/ 資料夾。Phase 4–9 type resolution 系統涵蓋可空值展開、for 迴圈型態推論、模式匹配、field/property 型態推論，支援 10+ 語言。新增 DeepSeek 模型設定、.gitignore/.gitnexusignore 尊重、MCP 啟動相容性改善、整合測試覆蓋。Bug 修復包括全域升級 ENOTEMPTY 錯誤、大型儲存庫解析快取持久化、Swift 解析器可用性篩選等。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.82)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.82 \n Target base: 1.6.6 (rc #82 )\n Source commit (main): b565c7c \n Release commit (versioned tree): e3a4687 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
