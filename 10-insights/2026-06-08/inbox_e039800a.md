...
id: inbox_e039800a
date: 2026-06-08
source_ref: "[[00-inbox/.../inbox_e039800a]]"
title: "Release Candidate v1.6.6-rc.157"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.157
source: gitnexus-releases
published_at: 2026-06-08T06:36:01+00:00
fetched_at: 2026-06-09T00:05:38.843600+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.157 自動生成 release candidate 構建，版本 v1.6.6-rc.157（rc #157），對應 main commit 3963c49。此版本功能和修復內容與 rc.158/159 相同，供早期驗收測試。包含 MCP 相容性、Swift 完整支援、Docker、HTTP embedding backend、O(n²) 優化等功能。可透過 npm install gitnexus@rc 安裝。"
key_points:
  - "v1.6.6-rc.157（rc #157），commit 3963c49，與前序 RC 功能集相同"
  - "包含 MCP 啟動相容性、Swift 完整支援、Docker support、HTTP embedding、O(n²) scope-capture 消除"
  - "早期驗收測試版本，功能集穩定"
...
## Release Candidate v1.6.6-rc.157

GitNexus v1.6.6-rc.157 自動生成 release candidate 構建，版本 v1.6.6-rc.157（rc #157），對應 main commit 3963c49。此版本功能和修復內容與 rc.158/159 相同，供早期驗收測試。包含 MCP 相容性、Swift 完整支援、Docker、HTTP embedding backend、O(n²) 優化等功能。可透過 npm install gitnexus@rc 安裝。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.157)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.157 \n Target base: 1.6.6 (rc #157 )\n Source commit (main): 3963c49 \n Release commit (versioned tree): 8a8b5f4 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
