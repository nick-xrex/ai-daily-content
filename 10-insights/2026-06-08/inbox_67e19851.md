...
id: inbox_67e19851
date: 2026-06-08
source_ref: "[[00-inbox/.../inbox_67e19851]]"
title: "Release Candidate v1.6.6-rc.158"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.158
source: gitnexus-releases
published_at: 2026-06-08T07:25:13+00:00
fetched_at: 2026-06-09T00:05:38.842680+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.158 自動生成 release candidate 構建，版本 v1.6.6-rc.158（rc #158），對應 main commit df5ce1f。此版本功能和修復內容與 rc.159 相同，供早期驗收測試。包含 MCP 相容性、Swift 完整支援、Docker、HTTP embedding backend、O(n²) 優化等功能。可透過 npm install gitnexus@rc 安裝。"
key_points:
  - "v1.6.6-rc.158（rc #158），commit df5ce1f，與 rc.159 功能集相同"
...
GitNexus v1.6.6-rc.158 自動生成 release candidate 構建，版本 v1.6.6-rc.158（rc #158），對應 main commit df5ce1f。此版本功能和修復內容與 rc.159 相同，供早期驗收測試。包含 MCP 相容性、Swift 完整支援、Docker、HTTP embedding backend、O(n²) 優化等功能。可透過 npm install gitnexus@rc 安裝。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.158)
