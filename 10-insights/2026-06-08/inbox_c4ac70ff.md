...
id: inbox_c4ac70ff
date: 2026-06-08
source_ref: "[[00-inbox/.../inbox_c4ac70ff]]"
title: "Release Candidate v1.6.6-rc.159"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.159
source: gitnexus-releases
published_at: 2026-06-08T08:00:39+00:00
fetched_at: 2026-06-09T00:05:38.841283+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.159 自動生成 release candidate 構建，版本 v1.6.6-rc.159（rc #159），對應 main commit 1ca4f15。包含最終版本前驗收測試內容：MCP 啟動相容性改進、KuzuDB fork crash 修復、HTTP embedding backend 遠端端點支援、Swift 完整支援（query fix、export detection、implicit imports、constructor resolution）、Docker 支援、預裝清理防止 ENOTEMPTY、快取目錄遷移至使用者可寫位置、Go O(n²) scope-capture 消除。可透過 npm install gitnexus@rc 安裝測試。"
key_points:
  - "v1.6.6-rc.159（rc #159），commit 1ca4f15，近最終版本的驗收構建"
  - "安全性及相容性：MCP startup compatibility lazy-load (#207)、KuzuDB fork crash 修復 (#209)、exec poisoning 防護 (#61)"
  - "效能優化：O(n²) Go scope-capture 消除（#1915）、parse cache 分片大規模倉庫（#1580）、preinstall 清理（#843）"
tags: [gitnexus, release-candidate, pre-release-testing]
topics: []
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.159

GitNexus v1.6.6-rc.159 自動生成 release candidate 構建，版本 v1.6.6-rc.159（rc #159），對應 main commit 1ca4f15。包含最終版本前驗收測試內容：MCP 啟動相容性改進、KuzuDB fork crash 修復、HTTP embedding backend 遠端端點支援、Swift 完整支援（query fix、export detection、implicit imports、constructor resolution）、Docker 支援、預裝清理防止 ENOTEMPTY、快取目錄遷移至使用者可寫位置、Go O(n²) scope-capture 消除。可透過 npm install gitnexus@rc 安裝測試。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.159)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.159 \n Target base: 1.6.6 (rc #159 )\n Source commit (main): 1ca4f15 \n Release commit (versioned tree): 7ccb17c \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
