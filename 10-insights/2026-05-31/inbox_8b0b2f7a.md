...
id: inbox_8b0b2f7a
date: 2026-05-31
source_ref: "[[00-inbox/2026-05-31/1801-gitnexus-releases-release-candidate-v1-6-6-rc-106-b470]]"
title: "Release Candidate v1.6.6-rc.106"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.106
source: gitnexus-releases
published_at: 2026-05-31T17:43:35+00:00
fetched_at: 2026-05-31T18:05:28.777454+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.106（2026-05-31 最新）發佈。代碼智能工具多維改進：Swift 語言完整支援（隱式導入、SPM 解析、建構子判別），HTTP embedding backend 支持自託管/遠端端點，新增 CLI index 命令、Docker 支援。性能優化消除 Go 語言 O(n²) scope-capture 重走複雜度。安全加強 MCP 啟動相容性、KuzuDB crash 測試。基礎設施修復全局升級 ENOTEMPTY、快取位置修正、macOS CI 整合。為正式 1.6.6 穩定版前的候選發佈。"
key_points:
  - "Swift 語言完整支援（隱式導入、SPM 導入解析、建構子判別）"
  - "O(n²) scope-capture 消除 + 大型倉庫快取分片，顯著性能提升"
  - "HTTP embedding backend 自託管支援、Docker、CLI index 命令、macOS CI 整合"
tags: [gitnexus, code-intelligence, embeddings, mcp-integration, language-support]
topics: [agents.mcp]
importance: 3
novelty: 2
insight_quality: 1
...
## Release Candidate v1.6.6-rc.106

GitNexus v1.6.6-rc.106（2026-05-31 最新）發佈。代碼智能工具多維改進：Swift 語言完整支援（隱式導入、SPM 解析、建構子判別），HTTP embedding backend 支持自託管/遠端端點，新增 CLI index 命令、Docker 支援。性能優化消除 Go 語言 O(n²) scope-capture 重走複雜度。安全加強 MCP 啟動相容性、KuzuDB crash 測試。基礎設施修復全局升級 ENOTEMPTY、快取位置修正、macOS CI 整合。為正式 1.6.6 穩定版前的候選發佈。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.106)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.106 \n Target base: 1.6.6 (rc #106 )\n Source commit (main): e275826 \n Release commit (versioned tree): 63b7c95 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
