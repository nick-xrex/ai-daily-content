...
id: inbox_d8ca1ea0
date: 2026-05-31
source_ref: "[[00-inbox/2026-05-31/1801-gitnexus-releases-release-candidate-v1-6-6-rc-105-19a5]]"
title: "Release Candidate v1.6.6-rc.105"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.105
source: gitnexus-releases
published_at: 2026-05-31T15:10:02+00:00
fetched_at: 2026-05-31T18:05:28.843025+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.105（2026-05-31）。自動 RC 發佈，特性集與 rc.106 相同：Swift 完整支援、HTTP embedding backend、MCP 相容性改進、O(n²) 消除、Docker 支援。持續 RC 候選等待穩定發佈。"
key_points:
  - "Swift 語言完整支援（隱式導入、SPM 導入解析、建構子判別）"
  - "O(n²) scope-capture 消除 + 大型倉庫快取分片"
  - "HTTP embedding backend 自託管支援、Docker、macOS CI 整合"
tags: [gitnexus, code-intelligence, embeddings, mcp-integration]
topics: [agents.mcp]
importance: 2
novelty: 1
insight_quality: 1
...
## Release Candidate v1.6.6-rc.105

GitNexus v1.6.6-rc.105（2026-05-31）。自動 RC 發佈，特性集與 rc.106 相同：Swift 完整支援、HTTP embedding backend、MCP 相容性改進、O(n²) 消除、Docker 支援。持續 RC 候選等待穩定發佈。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.105)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.105 \n Target base: 1.6.6 (rc #105 )\n Source commit (main): bb7a02d \n Release commit (versioned tree): 01480e8 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
