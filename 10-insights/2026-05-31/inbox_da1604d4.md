...
id: inbox_da1604d4
date: 2026-05-31
source_ref: "[[00-inbox/2026-05-31/1801-gitnexus-releases-release-candidate-v1-6-6-rc-102-e151]]"
title: "Release Candidate v1.6.6-rc.102"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.102
source: gitnexus-releases
published_at: 2026-05-31T10:33:12+00:00
fetched_at: 2026-05-31T18:05:28.865565+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.6-rc.102（2026-05-31）。自動 RC 發佈序列的版本，特性與前述 RC 相同，包含 Swift 支援、embeddings、MCP 相容性、性能最佳化，等候穩定版發佈。"
key_points:
...
## Release Candidate v1.6.6-rc.102

GitNexus v1.6.6-rc.102（2026-05-31）。自動 RC 發佈序列的版本，特性與前述 RC 相同，包含 Swift 支援、embeddings、MCP 相容性、性能最佳化，等候穩定版發佈。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.6-rc.102)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.6-rc.102 \n Target base: 1.6.6 (rc #102 )\n Source commit (main): b43aa10 \n Release commit (versioned tree): a1dda69 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
