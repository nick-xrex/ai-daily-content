...
id: inbox_5d416874
date: 2026-07-04
source_ref: "[[00-inbox/.../inbox_5d416874]]"
title: "Release Candidate v1.6.9-rc.47"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.9-rc.47
source: gitnexus-releases
published_at: 2026-07-04T06:05:21+00:00
fetched_at: 2026-07-05T01:42:20.747137+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.9-rc.47 發布，這是 v1.6.9 最終穩定版發佈前的第 47 個發布候選版本，已整合該穩定版本的全部功能與修復。版本包含跨倉庫 PDG 呼叫追蹤、HTTP 路由提取全語言支援（涵蓋 Java、Kotlin Spring、Django、FastAPI），以及 Java 和 Python 污點源/匯模型。工作空間索引動態化、搜尋改進包括 CJK 分詞分割、FTS 詞幹配置、向量距離閾值等。版本修復清單涵蓋 40+ 項改進，包括 LadybugDB 多寫死鎖修復、CUDA 13 GPU 加速支援、Ladybug 版本鎖定至 0.18.0、Windows @group 重開快取修復等關鍵修復。"
key_points:
  - "v1.6.9 最終 RC（rc.47）：包含跨倉庫呼叫追蹤、多語言 HTTP 路由提取（Java、Kotlin、Django、FastAPI）、污點分析源/匯模型"
  - "關鍵修復：LadybugDB 多寫死鎖修復、CUDA 13 GPU 加速支援、Ladybug 版本鎖定至 0.18.0、Windows @group 重開快取修復"
  - "40+ 項特性、修復和改進，涵蓋 Spring DI @Autowired List 解析、FTS 配置、icon 導入整合等"
tags: [gitnexus, release-candidate, multi-language-support, bugfix]
topics: []
importance: 3
novelty: 2
insight_quality: 2
...
GitNexus v1.6.9-rc.47 發布，這是 v1.6.9 最終穩定版發佈前的第 47 個發布候選版本，已整合該穩定版本的全部功能與修復。版本包含跨倉庫 PDG 呼叫追蹤、HTTP 路由提取全語言支援（涵蓋 Java、Kotlin Spring、Django、FastAPI），以及 Java 和 Python 污點源/匯模型。工作空間索引動態化、搜尋改進包括 CJK 分詞分割、FTS 詞幹配置、向量距離閾值等。版本修復清單涵蓋 40+ 項改進，包括 LadybugDB 多寫死鎖修復、CUDA 13 GPU 加速支援、Ladybug 版本鎖定至 0.18.0、Windows @group 重開快取修復等關鍵修復。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.9-rc.47)
