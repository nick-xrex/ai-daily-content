...
id: inbox_36ab313e
date: 2026-06-15
source_ref: "[[00-inbox/.../inbox_36ab313e]]"
title: "Release Candidate v1.6.8-rc.41"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.41
source: gitnexus-releases
published_at: 2026-06-15T21:19:35+00:00
fetched_at: 2026-06-17T00:15:28.730846+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.8-rc.41 是目標版本 1.6.8 的第 41 個候選版本，包含大量程序分析增強功能。新增功能包括：(1) Java Spring Route annotation 提取、(2) 多分支索引及分支範圍查詢、(3) 完整語言支持的控制流圖（CFG）訪問器與污染分析（包含內過程與過程間分析）、(4) MCP HTTP 服務器（支援 Streamable HTTP 和 SSE 傳輸）及新增最短呼叫路徑追蹤工具。修復部分包含嵌入索引建立、Docker 資產部署、大倉庫分析穩定性及影響範圍報告精度。效能優化含 SSA-sparse reaching-defs 演算法和圖資料庫持久化牆面時間減少。"
key_points:
  - "CFG 訪問器擴展至所有支持語言，含控制依賴建模及後支配者計算（Ferrante CDG）"
  - "污染分析覆蓋內過程與過程間（透過函數摘要），支援 taint 追蹤在代碼分析工作流中"
  - "MCP HTTP 伺服器啟用 Claude Code 整合，含查詢參數重命名以相容 Claude，新增追蹤工具查詢符號間最短呼叫路徑"
tags: [gitnexus, program-analysis, cfg, taint-analysis, mcp, code-graph]
topics: [agents.mcp]
importance: 3
novelty: 2
insight_quality: 3
...
## Release Candidate v1.6.8-rc.41

GitNexus v1.6.8-rc.41 是目標版本 1.6.8 的第 41 個候選版本，包含大量程序分析增強功能。新增功能包括：(1) Java Spring Route annotation 提取、(2) 多分支索引及分支範圍查詢、(3) 完整語言支持的控制流圖（CFG）訪問器與污染分析（包含內過程與過程間分析）、(4) MCP HTTP 服務器（支援 Streamable HTTP 和 SSE 傳輸）及新增最短呼叫路徑追蹤工具。修復部分包含嵌入索引建立、Docker 資產部署、大倉庫分析穩定性及影響範圍報告精度。效能優化含 SSA-sparse reaching-defs 演算法和圖資料庫持久化牆面時間減少。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.8-rc.41)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.8-rc.41 \n Target base: 1.6.8 (rc #41 )\n Source commit (main): 2d389a7 \n Release commit (versioned tree): 24e9a97 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
 ...
 Full Changelog : v1.6.7...v1.6.8-rc.41
