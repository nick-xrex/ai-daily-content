...
id: inbox_575f8455
date: 2026-08-04
source_ref: "[[00-inbox/.../inbox_575f8455]]"
title: "v0.38.0"
...
fetched_at: 2026-08-05T02:09:52.579635+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "Repowise v0.38.0 發佈大幅更新，強化文檔生成、頁面管理與搜索系統，新增 Svelte、Vue、HTML、reStructuredText 語言支持，擴展 Kotlin 與 C++ 代碼分析能力，並通過嵌入最佳化與詞彙排序提升性能。核心改進包括：用戶詞彙的自動挖掘與排序、層級分組的歸屬追踪、MCP 伺服器集成修復，以及大倉庫的解析快取持久化。"
key_points:
  - "多語言擴展：Svelte、Vue、HTML、reStructuredText 新支持，含 Kotlin、C++ 代碼分析方言"
  - "文檔生成智能化：詞彙挖掘、架構圖表、層級歸屬、自動概述和名詞解釋"
  - "效能與集成：O(n²) 嵌入優化、設定檔快取持久化、MCP 工具連接修復"
tags: [repowise, documentation-generation, code-analysis, multi-language-support, performance-optimization]
topics: []
importance: 3
novelty: 4
insight_quality: 4
...
**原文：** [repowise-releases](https://github.com/repowise-dev/repowise/releases/tag/v0.38.0)
