...
id: inbox_a765fb8e
date: 2026-08-04
source_ref: "[[00-inbox/2026-08-04/0144-gitnexus-releases-release-candidate-v1-6-10-rc-156-d8d8]]"
title: "Release Candidate v1.6.10-rc.156"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.156
source: gitnexus-releases
published_at: 2026-08-04T08:45:18+00:00
fetched_at: 2026-08-05T01:52:47.206954+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.156 的 changelist 與 rc.157 完全相同（source commit 4a2f4c8），包含 Docker 支援、HTTP embedding backend、完整 Swift 支援、auto-reindex with embeddings preservation、MCP 兼容性改進、O(n²) scope-capture re-walks 性能優化等關鍵更新。"
key_points:
  - "內容與 rc.157 相同：Docker、HTTP embeddings backend、Swift 完整支援"
  - "O(n²) 性能優化（scope-capture re-walks）、parse cache sharding、MCP 兼容性改進"
  - "全局升級修復與快取目錄設置"
...
## Release Candidate v1.6.10-rc.156

GitNexus v1.6.10-rc.156 的 changelist 與 rc.157 完全相同（source commit 4a2f4c8），包含 Docker 支援、HTTP embedding backend、完整 Swift 支援、auto-reindex with embeddings preservation、MCP 兼容性改進、O(n²) scope-capture re-walks 性能優化等關鍵更新。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.156)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.156 \n Target base: 1.6.10 (rc #156 )\n Source commit (main): 4a2f4c8 \n Release commit (versioned tree): 343a098 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
