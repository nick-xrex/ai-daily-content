...
id: inbox_8ac1a65b
date: 2026-08-04
source_ref: "[[00-inbox/2026-08-04/0144-gitnexus-releases-release-candidate-v1-6-10-rc-154-aa5f]]"
title: "Release Candidate v1.6.10-rc.154"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.154
source: gitnexus-releases
published_at: 2026-08-04T07:07:01+00:00
fetched_at: 2026-08-05T01:52:47.209670+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.154 的 changelist 與 rc.157 完全相同（source commit ca294e8），包含 Docker 支援、HTTP embedding backend、完整 Swift 支援、auto-reindex with embeddings preservation、MCP 兼容性改進、O(n²) scope-capture re-walks 性能優化等更新。"
key_points:
...
## Release Candidate v1.6.10-rc.154

GitNexus v1.6.10-rc.154 的 changelist 與 rc.157 完全相同（source commit ca294e8），包含 Docker 支援、HTTP embedding backend、完整 Swift 支援、auto-reindex with embeddings preservation、MCP 兼容性改進、O(n²) scope-capture re-walks 性能優化等更新。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.154)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.154 \n Target base: 1.6.10 (rc #154 )\n Source commit (main): ca294e8 \n Release commit (versioned tree): e496e10 \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
