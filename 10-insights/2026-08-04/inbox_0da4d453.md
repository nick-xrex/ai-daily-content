...
id: inbox_0da4d453
date: 2026-08-04
source_ref: "[[00-inbox/2026-08-04/0144-gitnexus-releases-release-candidate-v1-6-10-rc-155-f49b]]"
title: "Release Candidate v1.6.10-rc.155"
url: https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.155
source: gitnexus-releases
published_at: 2026-08-04T08:03:04+00:00
fetched_at: 2026-08-05T01:52:47.208454+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "GitNexus v1.6.10-rc.155 的 changelist 與 rc.157 完全相同（source commit 4c0a78f），包含 Docker 支援、HTTP embedding backend、完整 Swift 支援、auto-reindex with embeddings preservation、MCP 兼容性改進、O(n²) scope-capture re-walks 性能優化等更新。"
key_points:
...
## Release Candidate v1.6.10-rc.155

GitNexus v1.6.10-rc.155 的 changelist 與 rc.157 完全相同（source commit 4c0a78f），包含 Docker 支援、HTTP embedding backend、完整 Swift 支援、auto-reindex with embeddings preservation、MCP 兼容性改進、O(n²) scope-capture re-walks 性能優化等更新。
...
**原文：** [gitnexus-releases](https://github.com/abhigyanpatwari/GitNexus/releases/tag/v1.6.10-rc.155)
...
Automated release candidate build from main .\n\n npm: npm install gitnexus@rc \n Version: 1.6.10-rc.155 \n Target base: 1.6.10 (rc #155 )\n Source commit (main): 4c0a78f \n Release commit (versioned tree): 06a2ace \n\nRelease candidates are pre-stable builds intended for early testing. Stable releases remain on the latest dist-tag. 
