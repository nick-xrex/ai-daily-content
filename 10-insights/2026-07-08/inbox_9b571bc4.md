...
id: inbox_9b571bc4
date: 2026-07-08
source_ref: "[[00-inbox/2026-07-08/2207-codex-releases-0-143-0-dfba]]"
title: "0.143.0"
url: https://github.com/openai/codex/releases/tag/rust-v0.143.0
source: codex-releases
published_at: 2026-07-08T01:32:35+00:00
fetched_at: 2026-07-10T00:13:39.222476+00:00
model: claude-haiku-4-5
tokens_in: 0
tokens_out: 0
summary_zh: "OpenAI Codex v0.143.0 發布，新增多項功能和改進。主要新功能：(1) 遠程插件默認啟用，包含豐富目錄行、npm 市場源、本地/遠程版本可見性；(2) macOS 和 Windows 系統代理路由支持（PAC、WPAD 配置）；(3) codex remote-control 手動配對碼生成；(4) Amazon Bedrock 集成 GPT-5.6 Sol、Terra、Luna 三模型，支持最大推理努力；(5) MCP 工具默認使用工具搜索；(6) App-server 客戶端環境檢查、線程列表、歷史分叉功能。修復了 Windows ConPTY 輸入處理、MCP 啟動繁忙、exec server 離線恢復等問題。"
key_points:
  - "遠程插件默認啟用 + npm 市場源，促進插件生態"
  - "系統代理支持（PAC/WPAD），增強企業網路相容性"
  - "Amazon Bedrock 集成 GPT-5.6 Sol/Terra/Luna，支持最大推理努力"
tags: [codex, release, bedrock, gpt-5-6, plugin-ecosystem, system-proxy]
topics: []
importance: 3
novelty: 3
insight_quality: 3
...
OpenAI Codex v0.143.0 發布，新增多項功能和改進。主要新功能：(1) 遠程插件默認啟用，包含豐富目錄行、npm 市場源、本地/遠程版本可見性；(2) macOS 和 Windows 系統代理路由支持（PAC、WPAD 配置）；(3) codex remote-control 手動配對碼生成；(4) Amazon Bedrock 集成 GPT-5.6 Sol、Terra、Luna 三模型，支持最大推理努力；(5) MCP 工具默認使用工具搜索；(6) App-server 客戶端環境檢查、線程列表、歷史分叉功能。修復了 Windows ConPTY 輸入處理、MCP 啟動繁忙、exec server 離線恢復等問題。
...
**原文：** [codex-releases](https://github.com/openai/codex/releases/tag/rust-v0.143.0)
...
New Features 
 ...
 #29928 chore(app-server): mark thread/rollback as deprecated @
